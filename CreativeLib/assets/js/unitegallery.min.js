...
function UGCarousel() {
	function e(e, t) {
		g_objects = e.getObjects(), F = e, k = jQuery(e), L = g_objects.g_objWrapper, R = g_objects.g_arrItems, U = jQuery.extend(U, t), B.setFixedMode(), B.setApproveClickFunction(N), B.init(e, U), Y = B.getObjThumbs(), U = B.getOptions(), X.initTileWidth = U.tile_width, X.initTileHeight = U.tile_height, X.tileWidth = U.tile_width
	}
	function t(e) {
		if (!e) var e = L;
		var t = "<div class='ug-carousel-wrapper'><div class='ug-carousel-inner'></div></div>";
		L.append(t), Q = L.children(".ug-carousel-wrapper"), H = Q.children(".ug-carousel-inner"), B.setHtml(H), Y.getThumbs().fadeTo(0, 1)
	}
	function i(e, t) {
		if (!t) var t = X.initTileHeight / X.initTileWidth * e;
		X.tileWidth = e;
		var i = {
			tile_width: e,
			tile_height: t
	...
	function n() {
		if (null === X.carouselMaxWidth) throw new Error("The carousel width not set");
		if (X.tileWidth < X.initTileWidth) {
			var e = X.carouselMaxWidth - 2 * U.carousel_padding;
			e > X.initTileWidth && (e = X.initTileWidth), i(e);
			var t = W.getNumItemsInSpace(X.carouselMaxWidth, e, U.carousel_space_between_tiles)
		} else {
			var t = W.getNumItemsInSpace(X.carouselMaxWidth, X.tileWidth, U.carousel_space_between_tiles);
			if (0 >= t) {
				t = 1;
				var e = X.carouselMaxWidth - 2 * U.carousel_padding;
				i(e)
		...
		var n = W.getSpaceByNumItems(t, X.tileWidth, U.carousel_space_between_tiles);
		n += 2 * U.carousel_padding, Q.width(n), 1 == X.isFirstTimeRun ? (z(), B.run(), jQuery.each(R, function(e, t) {
			t.objThumbWrapper.data("index", e), L.trigger(X.eventSizeChange, [t.objThumbWrapper, !0]), t.objTileOriginal = t.objThumbWrapper.clone(!0, !0)
		}), m(!0), 1 == U.carousel_autoplay && G.startAutoplay()) : (1 == U.carousel_autoplay && G.pauseAutoplay(), I(0, !1), 1 == U.carousel_autoplay && G.startAutoplay()), P(), X.isFirstTimeRun = !1
	}
	function r() {
		return W.getElementSize(H).left
	}
	function o(e) {
		return W.getMousePosition(e).pageX
	}
	function a() {
	...
	function s(e) {
		var t = W.getNumItemsInSpace(e, X.tileWidth, U.carousel_space_between_tiles);
		return t
	}
	function l() {
		return a().length
	...
	function d() {
		return H.children(".ug-thumb-wrapper").first()
	}
	function _() {
		return H.children(".ug-thumb-wrapper").last()
	}
	function g(e, t, i) {
		var n = e.data("index");
		if (void 0 == n) throw new Error("every tile should have index!");
		for (var r = [], o = 0; t > o; o++) {
			if ("prev" == i) var a = F.getPrevItem(n, !0);
			else var a = F.getNextItem(n, !0);
	...
	function c() {
		var e = W.getElementSize(Q),
			t = W.getElementSize(H),
	...
	function m(e) {
		...
		return jQuery.each(i, function(e, o) {
			o = jQuery(o), W.placeElement(o, n, 0);
			var a = W.getElementSize(o);
			n += a.width + U.carousel_space_between_tiles, r = Math.max(r, a.height), e == i.length - 1 && (t = a.right)
		}), H.width(t), r += 2 * U.carousel_padding, e === !0 && (H.height(r), Q.height(r)), I(X.numCurrent, !1), t
	}
	function v(e) {
	...
	function b(e, t) {
		...
		jQuery.each(r, function(e, i) {
			"left" == t ? H.prepend(i) : H.append(i), L.trigger(X.eventSizeChange, i), B.loadTileImage(i)
		})
	}
	function y(e, t) {
		v(n);
	...
	function I(e, t, i) {
		if (void 0 === t) {
			var t = !0;
			if (H.is(":animated")) return !0
		}
		var n = u(e),
			r = W.getElementSize(n),
		...
		if (t === !0) {
			...
			i === !0 && (s = X.scrollShortDuration, l = X.scrollShortEasing), H.stop(!0).animate(a, {
				duration: s,
				easing: l,
				queue: !1,
				complete: function() {
		...
		} else X.numCurrent = e, H.css(a)
	}
	function E() {
		var e = -r(),
			t = s(e),
			i = W.getElementSize(u(t)).left,
			n = W.getElementSize(u(t + 1)).left;
	...
	function S() {
		var e = h(),
			...
			o = 0,
			a = l();
		if (e > X.spaceActionSize) i = s(e), b(i, "left"), X.numCurrent += i;
		else if (e < -X.spaceActionSize) {
			var r = s(Math.abs(e));
			y(r, "left"), X.numCurrent -= r
		}
		if (t > X.spaceActionSize ? (n = s(t), b(n, "right")) : t < -X.spaceActionSize && (o = s(Math.abs(t)), y(o, "right")), o > a) throw new Error("Can't remove more then num tiles");
		var u = !1;
		return (i || n || r || o) && (m(), u = !0), u
	}
	function P() {
		W.placeElement(H, 0, U.carousel_padding), S()
	}
	function x() {
		"left" == U.carousel_autoplay_direction ? G.scrollRight(1) : G.scrollLeft(1)
	}
	function j(e) {
		return 1 == X.touchActive ? !0 : (X.touchActive = !0, G.pauseAutoplay(), X.startTime = jQuery.now(), X.startMousePos = o(e), X.startInnerPos = r(), X.lastTime = X.startTime, X.lastMousePos = X.startMousePos, void W.storeEventData(e, X.storedEventID))
	}
	function C(e) {
		if (0 == X.touchActive) return !0;
		W.updateStoredEventData(e, X.storedEventID), e.preventDefault();
		var t = null;
		if (1 == U.carousel_vertical_scroll_ondrag && (t = W.handleScrollTop(X.storedEventID)), "vert" === t) return !0;
		X.lastMousePos = o(e);
		var i = X.lastMousePos - X.startMousePos,
			n = X.startInnerPos + i,
			r = i > 0 ? "prev" : "next",
			a = W.getElementSize(H).width;
		n > 0 && "prev" == r && (n /= 3), -a > n && "next" == r && (n = X.startInnerPos + i / 3), w(n)
	}
	function A() {
		return 0 == X.touchActive ? !0 : (X.touchActive = !1, T(), void G.unpauseAutoplay())
	}
	function M() {
		return 0 == U.carousel_autoplay_pause_onhover ? !0 : void(1 == X.isPlayMode && 0 == X.isPaused && G.pauseAutoplay())
	}
	function O() {
		return 0 == U.carousel_autoplay_pause_onhover ? !0 : void G.unpauseAutoplay()
	}
	function z() {
		B.initEvents(), Q.bind("mousedown touchstart", j), jQuery("body").bind("mousemove touchmove", C), jQuery(window).add("body").bind("mouseup touchend", A), Q.hover(M, O)
	}
	function N() {
		var e = X.lastTime - X.startTime,
			t = Math.abs(X.lastMousePos - X.startMousePos);
		return e > 300 ? !1 : t > 30 ? !1 : !0
	}
	var k, L, R, Q, H, G = this,
		D = jQuery(this),
	...
	this.startAutoplay = function() {
		X.isPlayMode = !0, X.isPaused = !1, D.trigger(G.events.START_PLAY), X.handle && clearInterval(X.handle), X.handle = setInterval(x, U.carousel_autoplay_timeout)
	}, this.unpauseAutoplay = function() {
		return 0 == X.isPlayMode ? !0 : 0 == X.isPaused ? !0 : void G.startAutoplay()
	}, this.pauseAutoplay = function() {
		return 0 == X.isPlayMode ? !0 : (X.isPaused = !0, X.handle && clearInterval(X.handle), void D.trigger(G.events.PAUSE_PLAY))
	}, this.stopAutoplay = function() {
		return 0 == X.isPlayMode ? !0 : (X.isPaused = !1, X.isPlayMode = !1, X.handle && clearInterval(X.handle), void D.trigger(G.events.STOP_PLAY))
	}, this.destroy = function() {
		X.handle && clearInterval(X.handle), D.off(G.events.START_PLAY), D.off(G.events.STOP_PLAY), Q.unbind("mousedown"), Q.unbind("touchstart"), jQuery("body").unbind("mousemove"), jQuery("body").unbind("touchmove"), jQuery(window).add("body").unbind("mouseup").unbind("touchend"), Q.off("mouseenter").off("mouseleave"), B.destroy()
	}, this.init = function(t, i, n) {
		n && this.setMaxWidth(n), e(t, i)
	}, this.setMaxWidth = function(e) {
		X.carouselMaxWidth = e
		...
		W.setButtonMobileReady(e), W.setButtonOnClick(e, G.scrollLeft)
	}, this.setScrollRightButton = function(e) {
		W.setButtonMobileReady(e), W.setButtonOnClick(e, G.scrollRight)
	}, this.setPlayPauseButton = function(e) {
		W.setButtonMobileReady(e), 1 == X.isPlayMode && 0 == X.isPaused && e.addClass("ug-pause-icon"), D.on(G.events.START_PLAY, function() {
			e.addClass("ug-pause-icon")
		}), D.on(G.events.STOP_PLAY, function() {
			e.removeClass("ug-pause-icon")
		}), W.setButtonOnClick(e, function() {
			0 == X.isPlayMode || 1 == X.isPaused ? G.startAutoplay() : G.stopAutoplay()
		})
	}
}
...
function UGFunctions() {
	...
	this.debugVar = "", this.z__________FULL_SCREEN___________ = function() {}, this.normalizePercent = function(e) {
		...
		var s = i.getImageInsideParentData(t, n, r, o, a),
			l = "<img class='hrefon'"; //sunyang 新增click
			//console.log(e);
		...
		for (var t = jQuery.fn.jquery.split("."), i = e.split("."), n = 0, r = t.length; r > n; n++) if (i[n] && parseInt(t[n]) < parseInt(i[n])) return !1;
		return !0
...
function UniteGalleryMain() {
	...
	function checkForStartupErrors() {
		var e = g_functions.checkMinJqueryVersion("1.8.0");
		0 == e && throwErrorShowMessage("The gallery can run from jquery 1.8 You have jQuery " + jQuery.fn.jquery + " Please update your jQuery library."), "object" == typeof g_objWrapper.outerWidth() && throwErrorShowMessage("You have some buggy script. most chances jquery-ui.js that destroy jquery outerWidth, outerHeight functions. The gallery can't run. Please update jquery-ui.js to latest version.")
	}
	function runGallery(e, i, n, r) {
		...
		if (o && (g_temp.objCustomOptions = i), 1 == g_temp.isRunFirstTime) {
			...
			g_temp.originalOptions = jQuery.extend({}, g_options), o && (g_options = jQuery.extend(g_options, i)), 1 == g_options.gallery_enable_cache && g_options.gallery_initial_catid && cacheItems(g_options.gallery_initial_catid);
		...
		checkForStartupErrors(), 1 == g_temp.isRunFirstTime && 1 == g_options.gallery_enable_tabs && (g_objTabs = new UGTabs, g_objTabs.init(t, g_options)), o && modifyInitParams(g_temp.objCustomOptions), validateParams(), 1 == g_options.gallery_shuffle && t.shuffleItems(), initTheme(g_temp.objCustomOptions), setGalleryHtml(), setHtmlObjectsProperties(); {
	...
	function onSliderMouseLeave() {
		if (1 == g_options.gallery_pause_on_mouseover && 1 == g_temp.isPlayMode && g_objSlider && 0 == g_objSlider.isSlideActionActive()) {
			var e = g_objSlider.isCurrentSlideLoadingImage();
			0 == e && t.continuePlaying()
		}
	}
	...
	var g_options = {
		...
		gallery_mousewheel_role: "zoom", //sunyang  zoom 滚动事件放大放小功能
	...
	this.onItemBigImageLoaded = function(e, t) {
		...
		if (unselectSeletedItem(), g_selectedItem = e, g_selectedItemIndex = i, g_objGallery.trigger(t.events.ITEM_CHANGE, e), 1 == g_temp.isPlayMode) {
			t.resetPlaying();
			var n = g_objSlider.isCurrentSlideLoadingImage();
			1 == n && t.pausePlaying()
		}
	}, this.nextItem = function() {
...
function UGGridPanel() {
	function e(e, i) {
		x = e, t(), i && i.vertical_scroll && (M.gridpanel_vertical_scroll = i.vertical_scroll), M = jQuery.extend(M, i), 1 == N.isHorType ? (M = jQuery.extend(M, z), M = jQuery.extend(M, i)) : 1 == M.gridpanel_vertical_scroll && (M = jQuery.extend(M, O), M = jQuery.extend(M, i), M.grid_panes_direction = "bottom");
		var n = x.getOptions(),
			r = n.gallery_skin;
		"" == M.gridpanel_arrows_skin && (M.gridpanel_arrows_skin = r);
		var o = e.getObjects();
		w = o.g_objWrapper, A.init(x, N, S, M, P)
	}
	function t() {
		if (null == N.orientation) throw new Error("Wrong orientation, please set panel orientation before run")
	}
	function i() {
		t(), o(), C.run(), l(), u(), y(), d()
	}
	function n() {
		w.append("<div class='ug-grid-panel'></div>"), I = w.children(".ug-grid-panel"), N.isHorType ? (I.append("<div class='grid-arrow grid-arrow-left-hortype ug-skin-" + M.gridpanel_arrows_skin + "'></div>"), I.append("<div class='grid-arrow grid-arrow-right-hortype ug-skin-" + M.gridpanel_arrows_skin + "'></div>"), T = I.children(".grid-arrow-left-hortype"), E = I.children(".grid-arrow-right-hortype")) : 0 == M.gridpanel_vertical_scroll ? (I.append("<div class='grid-arrow grid-arrow-left ug-skin-" + M.gridpanel_arrows_skin + "'></div>"), I.append("<div class='grid-arrow grid-arrow-right ug-skin-" + M.gridpanel_arrows_skin + "'></div>"), T = I.children(".grid-arrow-left"), E = I.children(".grid-arrow-right")) : (I.append("<div class='grid-arrow grid-arrow-up ug-skin-" + M.gridpanel_arrows_skin + "'></div>"), I.append("<div class='grid-arrow grid-arrow-down ug-skin-" + M.gridpanel_arrows_skin + "'></div>"), T = I.children(".grid-arrow-up"), E = I.children(".grid-arrow-down")), A.setHtml(I), T.fadeTo(0, 0), E.fadeTo(0, 0), x.initThumbsPanel("grid", M);
		var e = x.getObjects();
		C = e.g_objThumbs, C.setHtml(I), r()
	}
	function r() {
	...
	function a() {
		...
		return 1 == M.gridpanel_vertical_scroll && (e *= 2), e += M.gridpanel_padding_border_top + M.gridpanel_padding_border_bottom, t = N.panelHeight - e
	}
	function s() {
		...
		var n = j.getElementSize(E),
			r = n.width;
		return e += 2 * (r + M.gridpanel_arrows_padding_hor), t = N.panelWidth - e
	}
	function l() {
		var e = !1;
		...
		1 == e ? (E.show().fadeTo(0, 1), T.show().fadeTo(0, 1), N.arrowsVisible = !0) : (E.hide(), T.hide(), N.arrowsVisible = !1)
	}
	function u() {
		var e = C.getSize();
		1 == N.isHorType ? N.panelHeight = e.height + M.gridpanel_padding_border_top + M.gridpanel_padding_border_bottom : N.panelWidth = e.width + M.gridpanel_padding_border_left + M.gridpanel_padding_border_right, j.setElementSize(I, N.panelWidth, N.panelHeight)
	}
	function d() {
		return 1 == N.isEventsInited ? !1 : (N.isEventsInited = !0, T && (j.addClassOnHover(T), C.attachPrevPaneButton(T)), E && (j.addClassOnHover(E), C.attachNextPaneButton(E)), void A.initEvents())
	}
	function _() {
	...
	function c() {
		...
		case "middle":
			...
			break;
		case "bottom":
			e = N.panelHeight - o.height - r.height - M.gridpanel_padding_border_bottom - M.gridpanel_arrows_padding_vert
		}
		var a = _(),
			s = C.getElement();
		...
		case "center":
		case "middle":
			t = (o.top - r.height) / 2, i = o.bottom + (N.panelHeight - o.bottom - r.height) / 2, n = 0;
			break;
		case "grid":
	...
	function p() {
		...
		case "middle":
			...
			case "border":
			case "borders":
				var l = N.panelHeight - r.height - M.gridpanel_padding_border_bottom;
				a = (l - o.height) / 2
			}
			break;
		case "bottom":
			var s = o.height + r.height + M.gridpanel_arrows_padding_vert;
			a = N.panelHeight - s - M.gridpanel_padding_border_bottom
		}
		var u = C.getElement(),
			d = _();
		...
		case "center":
		case "middle":
			e = o.bottom + (N.panelHeight - o.bottom - r.height) / 2, i = 0;
			break;
		case "grid":
	...
	function m() {
		...
		case "center":
			...
			break;
		case "right":
			e = N.panelWidth - o.width - r.width - M.gridpanel_padding_border_right - M.gridpanel_arrows_padding_hor
		}
		var a = C.getElement();
		...
		case "top":
			...
			break;
		case "bottom":
			n = N.panelHeight - M.gridpanel_padding_border_bottom - M.gridpanel_arrows_padding_vert - r.height
		}
		switch (M.gridpanel_arrows_align_hor) {
		default:
		case "borders":
			t = M.gridpanel_padding_border_left, i = N.panelWidth - M.gridpanel_padding_border_right - r.width;
			break;
		case "grid":
			t = o.left - M.gridpanel_arrows_padding_hor - r.width, i = o.right + M.gridpanel_arrows_padding_hor;
			break;
		case "center":
			t = (o.left - r.width) / 2, i = o.right + (N.panelWidth - o.right - r.width) / 2
		}
	...
	function v() {
		...
		case "center":
			...
			break;
		case "right":
			e = N.panelWidth - t.width - M.gridpanel_padding_border_right
		}
		var i = C.getElement();
		j.placeElement(i, e, M.gridpanel_padding_border_top)
	}
	function b() {
		1 == N.arrowsVisible ? m() : v()
	}
	function y() {
		0 == N.isHorType ? 1 == M.gridpanel_vertical_scroll ? h() : f() : b(), A.placeElements()
	}
	var w, I, E, T, S = this,
		P = jQuery(this),
	...
	this.destroy = function() {
		...
		if (1 == N.isHorType) throw new Error("setHeight is not appliable to this orientatio (" + N.orientation + "). Please use setWidth");
		N.panelHeight = e;
		var t = a();
		C.setMaxHeight(t)
	}, this.setWidth = function(e) {
		if (0 == N.isHorType) throw new Error("setWidth is not appliable to this orientatio (" + N.orientation + "). Please use setHeight");
		N.panelWidth = e;
		var t = s();
		C.setMaxWidth(t)
...
function UGLightbox() {
	function e(e, i) {
		$ = e, B = jQuery(e), nt = jQuery.extend(nt, ot), nt = jQuery.extend(nt, i), rt.originalOptions = jQuery.extend({}, nt), "compact" == nt.lightbox_type && (rt.isCompact = !0, nt = jQuery.extend(nt, at), nt = jQuery.extend(nt, i)), t(), 1 == rt.putSlider ? ($.initSlider(nt, "lightbox"), g_objects = e.getObjects(), et = g_objects.g_objSlider) : et = null, 1 == nt.lightbox_show_textpanel ? it.init($, nt, "lightbox") : it = null
	}
	function t() {
		1 == rt.isCompact && 1 == nt.lightbox_show_textpanel && (nt.lightbox_slider_image_padding_bottom = rt.initTextPanelHeight), 1 == rt.isCompact && "inside" == nt.lightbox_arrows_position && (rt.isArrowsInside = !0), 1 == rt.isArrowsInside && 0 == nt.lightbox_arrows_inside_alwayson && (rt.isArrowsOnHoverMode = !0)
	}
	function i() {
		var e = "",
			t = "";
		1 == rt.isCompact && (t = " ug-lightbox-compact"), e += "<div class='ug-gallery-wrapper ug-lightbox" + t + "'>", e += "<div class='ug-lightbox-overlay'></div>", 0 == rt.isCompact && (e += "<div class='ug-lightbox-top-panel'>"), e += "<div class='ug-lightbox-top-panel-overlay'></div>", e += "<div class='ug-lightbox-button-close'></div>", nt.lightbox_show_numbers && (e += "<div class='ug-lightbox-numbers'></div>"), 0 == rt.isCompact && (e += "</div>"), e += "<div class='ug-lightbox-arrow-left'></div>", e += "<div class='ug-lightbox-arrow-right'></div>", e += "</div>", Y = jQuery(e), jQuery("body").append(Y), et && et.setHtml(Y), U = Y.children(".ug-lightbox-overlay"), 0 == rt.isCompact && (K = Y.children(".ug-lightbox-top-panel")), Z = Y.find(".ug-lightbox-button-close"), nt.lightbox_show_numbers && (q = Y.find(".ug-lightbox-numbers")), X = Y.children(".ug-lightbox-arrow-left"), V = Y.children(".ug-lightbox-arrow-right"), it && it.appendHTML(K ? K : Y)
	}
	function n() {
		if (null !== nt.lightbox_overlay_color && U.css("background-color", nt.lightbox_overlay_color), null !== nt.lightbox_overlay_opacity && U.fadeTo(0, nt.lightbox_overlay_opacity), K && null !== nt.lightbox_top_panel_opacity && K.children(".ug-lightbox-top-panel-overlay").fadeTo(0, nt.lightbox_top_panel_opacity), q) {
			var e = {};
			null !== nt.lightbox_numbers_size && (e["font-size"] = nt.lightbox_numbers_size + "px"), nt.lightbox_numbers_color && (e.color = nt.lightbox_numbers_color), null !== nt.lightbox_numbers_padding_right && (e["padding-right"] = nt.lightbox_numbers_padding_right + "px"), null !== nt.lightbox_numbers_padding_top && (e["padding-top"] = nt.lightbox_numbers_padding_top + "px"), q.css(e)
		}
	}
	function r(e) {
		if (!et) return !0;
		...
		et.setOptions(t), et.refreshSlideItems()
	}
	function o() {
		if (!K) return !1;
		if (!it) return !1;
	...
	function s(e) {
		...
		if (a != o.slider_image_padding_bottom) {
			...
			if (0 == et.isAnimating()) return et.setOptions(s), et.refreshSlideItems(), !0
		}
		return !1
	}
	function l(e, t) {
		if (!e) var i = et.getSlideImage(),
			e = tt.getElementSize(i);
		rt.textPanelTop = e.bottom, t === !0 && it.positionPanel(rt.textPanelTop, rt.textPanelLeft)
	}
	function u(e) {
		var t = (tt.getElementSize(Y), et.getSlideImage()),
			i = tt.getElementSize(t);
		if (0 == i.width) return !1;
		rt.textPanelLeft = i.left, rt.textPanelTop = i.bottom;
		var n = i.width;
		if (q) {
			var r = tt.getElementSize(q);
			n -= r.width;
			var o = i.right - r.width;
			tt.placeElement(q, o, rt.textPanelTop)
		}
		it && (it.show(), it.refresh(!0, !0, n), l(i));
		var a = s(i);
		0 == a && (rt.positionFrom = "handleCompactTextpanelSizes", it && (it.positionPanel(rt.textPanelTop, rt.textPanelLeft), e === !0 && (e(), P())))
	}
	function d() {
		if (0 == et.isCurrentSlideType("image")) return !0;
		var e = 1 == et.isCurrentImageInPlace();
		return e
	}
	function _(e, t) {
		if (0 == rt.isArrowsInside) return !1;
		if (!X) return !1;
		var i = d();
		if (X.show(), V.show(), rt.positionFrom = "positionArrowsInside", 1 == rt.isArrowsOnHoverMode && 1 == i && 0 == v() && b(!0), 0 == i) var n = tt.getElementRelativePos(X, "left", nt.lightbox_arrows_offset),
			r = tt.getElementRelativePos(X, "middle"),
			o = tt.getElementRelativePos(V, "right", nt.lightbox_arrows_offset),
			a = r;
		else var s = et.getSlideImage(),
			l = tt.getElementSize(s),
			n = (tt.getElementSize(et.getElement()), tt.getElementRelativePos(X, "left", 0, s) + l.left + nt.lightbox_arrows_inside_offset),
			r = tt.getElementRelativePos(X, "middle", 0, s) + l.top,
			o = tt.getElementRelativePos(X, "right", 0, s) + l.left - nt.lightbox_arrows_inside_offset,
			a = r;
		if (t === !0) {
			var u = {
				left: n,
			...
			X.stop().animate(u, {
				duration: rt.fadeDuration
			}), V.stop().animate(_, {
				duration: rt.fadeDuration
			})
		} else X.stop(), V.stop(), tt.placeElement(X, n, r), tt.placeElement(V, o, a);
		1 == e && w(t)
	}
	function g(e, t) {
		rt.positionFrom = null;
		var i = d(),
			n = 2,
			r = tt.getElementRelativePos(Z, "right", 2, Y);
		if (0 == i) var o = n,
			a = r;
		else {
			var s = et.getSlideImage(),
				l = tt.getElementSize(s),
				u = tt.getElementSize(et.getElement()),
				_ = tt.getElementSize(Z);
			u.top == u.height && (u.top = 0);
			var a = u.left + l.right - _.width / 2 + nt.lightbox_compact_closebutton_offsetx,
				o = u.top + l.top - _.height / 2 - nt.lightbox_compact_closebutton_offsety;
			n > o && (o = n), a > r && (a = r)
		}
		if (t === !0) {
			var g = {
		...
		} else Z.stop(), tt.placeElement(Z, a, o);
		e === !0 && I(t)
	}
	function c() {
		Z && Z.stop().fadeTo(rt.fadeDuration, 0), f(), m(), rt.positionFrom = "hideCompactElements", 1 == rt.isArrowsInside && b()
	}
	function h() {
		Z && Z.hide(), X && 1 == rt.isArrowsInside && (X.hide(), V.hide()), q && q.hide(), it && it.hide()
	}
	function p() {
		var e = tt.getElementSize(Y);
		K && tt.setElementSizeAndPosition(K, 0, 0, e.width, rt.topPanelHeight), X && 0 == rt.isArrowsInside && (1 == nt.lightbox_hide_arrows_onvideoplay && (X.show(), V.show()), tt.placeElement(X, "left", "middle", nt.lightbox_arrows_offset), tt.placeElement(V, "right", "middle", nt.lightbox_arrows_offset)), 0 == rt.isCompact && tt.placeElement(Z, "right", "top", 2, 2), it && (rt.positionFrom = "positionElements", 0 == rt.isCompact ? a(e) : (S(), P()));
		var t = e.width,
			i = e.height,
			n = 0,
			r = 0;
		if (et) {
			...
			et.setSize(t, i), et.setPosition(r, n)
		}
	}
	function f() {
		it && it.getElement().stop().fadeTo(rt.fadeDuration, 0)
	}
	function m() {
		q && q.stop().fadeTo(rt.fadeDuration, 0)
	}
	function v() {
		if (!rt.lastMouseX) return !0;
		var e = {
			pageX: rt.lastMouseX,
			pageY: rt.lastMouseY
		},
			t = et.isMouseInsideSlideImage(e);
		return t
	}
	function b(e, t) {
		return X ? 1 == rt.isArrowsOnHoverMode && t === !1 ? (1 == v(), !0) : void(e === !0 ? (X.stop().fadeTo(0, 0), V.stop().fadeTo(0, 0)) : (X.stop().fadeTo(rt.fadeDuration, 0), V.stop().fadeTo(rt.fadeDuration, 0))) : !1
	}
	function y() {
		if (!X) return !0;
	...
	function w(e, t) {
		return X ? 1 == rt.isArrowsOnHoverMode && t !== !0 && 1 == d() ? !0 : 1 == et.isSwiping() ? !0 : (e !== !0 && (X.stop(), V.stop()), X.fadeTo(rt.fadeDuration, 1), void V.fadeTo(rt.fadeDuration, 1)) : !1
	}
	function I(e) {
		e !== !0 && Z.stop(), Z.fadeTo(rt.fadeDuration, 1)
	}
	function E(e) {
		if (!it) return !1;
		if (!e) var e = et.getCurrentItem();
		it.setTextPlain(e.title, e.description)
	}
	function T(e) {
		if (!q) return !1;
		if (!e) var e = et.getCurrentItem();
	...
	function S() {
		return it ? void it.getElement().show().stop().fadeTo(rt.fadeDuration, 1) : !1
	}
	function P() {
		q && q.stop().fadeTo(rt.fadeDuration, 1)
	}
	function x() {
		return 0 == rt.isCompact ? !0 : void c()
	}
	function j() {
		if (0 == rt.isCompact) return !0;
		if (rt.positionFrom = "onZoomChange", g(!1, !0), _(!1, !0), 1 == rt.isCompact) {
			var e = et.isCurrentSlideType("image") && 1 == et.isCurrentImageInPlace();
			0 == e ? (f(), m()) : (rt.positionFrom = "onZoomChange", S(), P())
		}
	}
	function C() {
		if (0 == rt.isCompact) return !0;
		rt.positionFrom = "onSliderAfterReturn", g(!0), _(!0);
		var e = s();
		0 == e && u(), S(), P()
	}
	function A(e, t) {
		return t = jQuery(t), 0 == rt.isCompact ? !0 : 0 == et.isSlideCurrent(t) ? !0 : (rt.positionFrom = "onSliderAfterPutImage", g(!0), _(!0), void u())
	}
	function M() {
		var e = et.getOptions(),
		...
		if (1 == rt.isCompact && (E(), T(), rt.positionFrom = "onSliderTransitionEnd", g(!0), _(!0), 0 == et.isSlideActionActive())) {
			var n = s();
			0 == n && u(), S(), P()
		}
	}
	function O(e, t) {
		0 == rt.isCompact ? (q && T(t), it && (E(t), it.positionElements(!1), o(), it.positionPanel())) : 0 == et.isAnimating() && (it && E(t), q && T(t))
	}
	function z(e, t) {
		var i = et.getSlideType();
		if ("image" != i && 0 == rt.isCompact && et.isSlideActionActive()) return !0;
		var n = et.isPreloading();
		if (1 == n) return J.close("slider"), !0;
		var r = et.isMouseInsideSlideImage(t);
	...
	function k() {
		X && 1 == nt.lightbox_hide_arrows_onvideoplay && (X.hide(), V.hide())
	}
	function L() {
		X && 1 == nt.lightbox_hide_arrows_onvideoplay && (X.show(), V.show())
	}
	function R(e, t) {
		switch (t) {
		case 27:
			1 == rt.isOpened && J.close("keypress")
		}
	}
	function Q() {
		1 == rt.isArrowsOnHoverMode && w(!1, !0)
	}
	function H() {
		rt.positionFrom = "hideCompactElements", 1 == rt.isArrowsOnHoverMode && 1 == d() && b(!1, !0)
	}
	function G(e) {
		rt.lastMouseX = e.pageX, rt.lastMouseY = e.pageY;
		var t = y();
		1 == t && v() && 0 == et.isAnimating() && (rt.positionFrom = "onMouseMove", X && 0 == X.is(":animated") && w(!1, !0))
	}
	function D(e, t, i, n) {
		if (0 == rt.isOpened) return !0;
		switch (nt.gallery_mousewheel_role) {
		default:
		case "zoom":
			var r = et.getSlideType();
	...
	function F() {
		if (U.on("touchstart", function(e) {
			...
			J.close("overlay")
		}), tt.addClassOnHover(V, "ug-arrow-hover"), tt.addClassOnHover(X, "ug-arrow-hover"), tt.addClassOnHover(Z), $.setNextButton(V), $.setPrevButton(X), Z.click(function() {
			J.close("button")
		}), B.on($.events.ITEM_CHANGE, O), et) {
			jQuery(et).on(et.events.TRANSITION_END, M), jQuery(et).on(et.events.CLICK, z);
			var e = et.getVideoObject();
			jQuery(e).on(e.events.PLAY_START, k), jQuery(e).on(e.events.PLAY_STOP, L), jQuery(et).on(et.events.START_DRAG, x), jQuery(et).on(et.events.TRANSITION_START, x), jQuery(et).on(et.events.AFTER_DRAG_CHANGE, C), jQuery(et).on(et.events.AFTER_RETURN, C), jQuery(et).on(et.events.AFTER_PUT_IMAGE, A), jQuery(et).on(et.events.ZOOM_CHANGE, j), jQuery(et).on(et.events.IMAGE_MOUSEENTER, Q), jQuery(et).on(et.events.IMAGE_MOUSELEAVE, H)
		}
		jQuery(window).resize(function() {
			return 0 == rt.isOpened ? !0 : void tt.whenContiniousEventOver("lightbox_resize", N, 100)
		}), B.on($.events.GALLERY_KEYPRESS, R), 1 == rt.isArrowsOnHoverMode && jQuery(document).bind("mousemove", G), Y.on("mousewheel", D)
	}
	function W() {
		rt.isCompact = !1, t(), nt = jQuery.extend({}, rt.originalOptions), trace(nt), et.setOptions(nt)
	}
	var B, Y, U, X, V, Z, q, K, J = this,
		$ = (jQuery(this), new UniteGalleryMain),
		et = new UGSlider,
		tt = new UGFunctions,
		it = new UGTextPanel,
		nt = {
	...
	var rt = {
		...
		ot = {
			...
			lightbox_slider_image_padding_top: rt.topPanelHeight,
			lightbox_slider_image_padding_bottom: 10,
			lightbox_slider_video_padding_top: rt.topPanelHeight,
	...
	this.destroy = function() {
		if (jQuery(document).unbind("mousemove"), U.off("touchstart"), U.off("touchend"), Z.off("click"), B.off($.events.ITEM_CHANGE), et) {
			jQuery(et).off(et.events.TRANSITION_END), jQuery(et).off(et.events.CLICK), jQuery(et).off(et.events.START_DRAG), jQuery(et).off(et.events.TRANSITION_START), jQuery(et).off(et.events.AFTER_DRAG_CHANGE), jQuery(et).off(et.events.AFTER_RETURN);
			var e = et.getVideoObject();
			jQuery(e).off(e.events.PLAY_START), jQuery(e).off(e.events.PLAY_STOP), jQuery(et).on(et.events.IMAGE_MOUSEENTER, Q), jQuery(et).on(et.events.IMAGE_MOUSELEAVE, H), et.destroy()
		}
		jQuery(window).unbind("resize"), B.off($.events.GALLERY_KEYPRESS, R), Y.off("mousewheel"), Y.remove()
	}, this.open = function(e) {
		var t = $.getItem(e);
		if (rt.isOpened = !0, et && et.setItem(t, "lightbox_open"), it && it.setTextPlain(t.title, t.description), U.stop().fadeTo(0, 0), Y.show(), Y.fadeTo(0, 1), U.stop().fadeTo(rt.fadeDuration, nt.lightbox_overlay_opacity), p(), 1 == rt.isCompact) {
			var i = et.isPreloading();
			1 == i ? h() : 1 == rt.isArrowsInside && (X.hide(), V.hide())
		}
		et && et.startSlideAction()
	}, this.close = function() {
		rt.isOpened = !1, 1 == rt.isCompact && c(), et && et.stopSlideAction();
		var e = et.getSlideType();
		"image" != e ? Y.hide() : Y.fadeTo(rt.fadeDuration, 0, function() {
			Y.hide()
		})
	}, this.init = function(t, i) {
		e(t, i)
...
function UGSlider() {
	function e(e, t, n) {
		ft = e, n && (ct = n, t = wt.convertCustomPrefixOptions(t, ct, "slider")), et = jQuery(e);
		var r = ft.getObjects();
		if (tt = r.g_objWrapper, it = r.g_objThumbs, t.hasOwnProperty("slider_progress_indicator_type") && (Tt.slider_progress_indicator_type = t.slider_progress_indicator_type), "bar" == Tt.slider_progress_indicator_type && (Tt = jQuery.extend(Tt, St)), t && ht.setOptions(t), i(), 1 == Tt.slider_enable_bullets) {
			bt = new UGBullets;
			var o = {
				bullets_skin: Tt.slider_bullets_skin,
				bullets_space_between: Tt.slider_bullets_space_between
			};
			bt.init(ft, o)
		}
		Tt.slider_enable_text_panel && (Et = new UGTextPanel, Et.init(ft, Tt, "slider")), Tt.slider_enable_zoom_panel && (gt = new UGZoomButtonsPanel, gt.init(ht, Tt));
		var a = ft.getGalleryID();
		yt.init(Tt, !1, a)
	}
	function t() {
		if (1 == Pt.isRunOnce) return !1;
		if (Pt.isRunOnce = !0, Tt.slider_background_color) {
			var e = Tt.slider_background_color;
			1 != Tt.slider_background_opacity && (e = wt.convertHexToRGB(e, Tt.slider_background_opacity)), nt.css("background-color", e)
		} else 1 != Tt.slider_background_opacity && (e = wt.convertHexToRGB("#000000", Tt.slider_background_opacity), nt.css("background-color", e));
		1 == Tt.slider_control_swipe && (dt = new UGTouchSliderControl, dt.init(ht, Tt)), 1 == Tt.slider_control_zoom && (_t = new UGZoomSliderControl, _t.init(ht, Tt)), Et && Et.run(), X()
	}
	function i() {
		var e = ft.getOptions(),
			t = e.gallery_skin;
		"" == Tt.slider_bullets_skin && (Tt.slider_bullets_skin = t), "" == Tt.slider_arrows_skin && (Tt.slider_arrows_skin = t), "" == Tt.slider_zoompanel_skin && (Tt.slider_zoompanel_skin = t), "" == Tt.slider_play_button_skin && (Tt.slider_play_button_skin = t), "" == Tt.slider_fullscreen_button_skin && (Tt.slider_fullscreen_button_skin = t), Tt.video_enable_closebutton = Tt.slider_video_enable_closebutton, "zoom" != e.gallery_mousewheel_role && (Tt.slider_zoom_mousewheel = !1)
	}
	function n(e, t) {
		var i = "ug-type-square";
		return "round" == Tt.slider_videoplay_button_type && (i = "ug-type-round"), html = "", html += "<div class='ug-slide-wrapper ug-slide" + t + "'>", html += "<div class='ug-item-wrapper'></div>", html += "<div class='ug-slider-preloader " + e + "'></div>", html += "<div class='ug-button-videoplay " + i + "' style='display:none'></div>", html += "</div>"
	}
	function r(e) {
		e && (tt = e);
		var t = V(),
			i = (ft.getOptions(), "<div class='ug-slider-wrapper'>");
		if (i += "<div class='ug-slider-inner'>", i += n(t, 1), i += n(t, 2), i += n(t, 3), i += "</div>", 1 == Tt.slider_enable_arrows && (i += "<div class='ug-slider-control ug-arrow-left ug-skin-" + Tt.slider_arrows_skin + "'></div>", i += "<div class='ug-slider-control ug-arrow-right ug-skin-" + Tt.slider_arrows_skin + "'></div>"), 1 == Tt.slider_enable_play_button && (i += "<div class='ug-slider-control ug-button-play ug-skin-" + Tt.slider_play_button_skin + "'></div>"), 1 == Tt.slider_enable_fullscreen_button && (i += "<div class='ug-slider-control ug-button-fullscreen ug-skin-" + Tt.slider_fullscreen_button_skin + "'></div>"), i += "</div>", tt.append(i), nt = tt.children(".ug-slider-wrapper"), rt = nt.children(".ug-slider-inner"), ot = rt.children(".ug-slide1"), at = rt.children(".ug-slide2"), st = rt.children(".ug-slide3"), ot.data("slidenum", 1), at.data("slidenum", 2), st.data("slidenum", 3), bt && bt.appendHTML(nt), 1 == Tt.slider_enable_arrows && (lt = nt.children(".ug-arrow-left"), ut = nt.children(".ug-arrow-right")), 1 == Tt.slider_enable_play_button && (mt = nt.children(".ug-button-play")), 1 == Tt.slider_enable_fullscreen_button && (vt = nt.children(".ug-button-fullscreen")), 1 == Tt.slider_enable_progress_indicator) {
			It = wt.initProgressIndicator(Tt.slider_progress_indicator_type, Tt, nt);
			var r = It.getType();
			"bar" == r && "pie" == Tt.slider_progress_indicator_type && (Tt.slider_progress_indicator_type = "bar", Tt = jQuery.extend(Tt, St)), ft.setProgressIndicator(It)
		}
		if (1 == Tt.slider_enable_text_panel && (Et.appendHTML(nt), 0 == Tt.slider_textpanel_always_on)) {
			var o = Et.getElement();
			o.hide().data("isHidden", !0), Pt.isTextPanelSaparateHover = !0
		}
		1 == Tt.slider_enable_zoom_panel && gt.appendHTML(nt), yt.setHtml(rt);
	}
	function o(e) {
		var t = K(e);
		wt.placeElementInParentCenter(t);
		var i = J(e);
		wt.placeElementInParentCenter(i);
	}
	function a() {
		if (bt && (objBullets = bt.getElement(), wt.placeElement(objBullets, Tt.slider_bullets_align_hor, Tt.slider_bullets_align_vert, Tt.slider_bullets_offset_hor, Tt.slider_bullets_offset_vert), wt.placeElement(objBullets, Tt.slider_bullets_align_hor, Tt.slider_bullets_align_vert, Tt.slider_bullets_offset_hor, Tt.slider_bullets_offset_vert)), 1 == Tt.slider_enable_arrows && (wt.placeElement(lt, Tt.slider_arrow_left_align_hor, Tt.slider_arrow_left_align_vert, Tt.slider_arrow_left_offset_hor, Tt.slider_arrow_left_offset_vert), wt.placeElement(ut, Tt.slider_arrow_right_align_hor, Tt.slider_arrow_left_align_vert, Tt.slider_arrow_right_offset_hor, Tt.slider_arrow_right_offset_vert)), 0 == Tt.slider_controls_always_on && A(!0), It) {
			var e = It.getElement();
			if ("bar" == Tt.slider_progress_indicator_type) {
				var t = nt.width();
				It.setSize(t), wt.placeElement(e, "left", Tt.slider_progress_indicator_align_vert, 0, Tt.slider_progress_indicator_offset_vert)
			} else wt.placeElement(e, Tt.slider_progress_indicator_align_hor, Tt.slider_progress_indicator_align_vert, Tt.slider_progress_indicator_offset_hor, Tt.slider_progress_indicator_offset_vert)
		}
		Et && Et.positionPanel(), s(), o(ot), o(at), o(st), j();
	}
	function s() {
		if (mt && wt.placeElement(mt, Tt.slider_play_button_align_hor, Tt.slider_play_button_align_vert, Tt.slider_play_button_offset_hor, Tt.slider_play_button_offset_vert), vt && wt.placeElement(vt, Tt.slider_fullscreen_button_align_hor, Tt.slider_fullscreen_button_align_vert, Tt.slider_fullscreen_button_offset_hor, Tt.slider_fullscreen_button_offset_vert), gt) {
			var e = gt.getElement();
			wt.placeElement(e, Tt.slider_zoompanel_align_hor, Tt.slider_zoompanel_align_vert, Tt.slider_zoompanel_offset_hor, Tt.slider_zoompanel_offset_vert)
		}
	}
	function l() {
		var e, t, i, n, r = ht.getSlidesReference(),
			o = 0,
			a = 0,
			s = 0;
		i = ht.isSlideHasItem(r.objNextSlide), n = ht.isSlideHasItem(r.objPrevSlide), n ? (s = r.objPrevSlide.outerWidth(), r.objPrevSlide.css("z-index", 1)) : r.objPrevSlide.hide(), t = s + r.objCurrentSlide.outerWidth(), e = t, i ? (e = t + r.objNextSlide.outerWidth(), r.objPrevSlide.css("z-index", 2)) : r.objNextSlide.hide(), r.objCurrentSlide.css("z-index", 3), wt.placeElement(r.objCurrentSlide, s, o), rt.css({
			left: -s + "px",
			width: e + "px"
		}), n && (wt.placeElement(r.objPrevSlide, a, o), wt.showElement(r.objPrevSlide)), i && (wt.showElement(r.objNextSlide), wt.placeElement(r.objNextSlide, t, o))
	}
	function u(e) {
		var t = e.data("index");
	...
	function g(e, t) {
		var i = {};
		1 == Tt.slider_image_border && (i["border-style"] = "solid", i["border-width"] = Tt.slider_image_border_width + "px", i["border-color"] = Tt.slider_image_border_color, i["border-radius"] = Tt.slider_image_border_radius), "image" != t && 1 == Tt.slider_video_constantsize && (i["background-color"] = "#000000"), 1 == Tt.slider_image_shadow && (i["box-shadow"] = "3px 3px 10px 0px #353535"), e.css(i)
	}
	function c(e, t) {
		var i = Tt.slider_video_constantsize_width,
			n = Tt.slider_video_constantsize_height,
			r = Tt.slider_video_constantsize_scalemode;
		wt.scaleImageExactSizeInParent(e, t.imageWidth, t.imageHeight, i, n, r)
	}
	function h(e, t, i) {
	//console.log(t);
		var n = e.children(".ug-item-wrapper"),
			...
			a = e.data("urlImage");
		e.data("urlImage", o);
		var s = ht.getScaleMode(e),
			l = ht.getSlideType(e);
		if (objPadding = ht.getObjImagePadding(), a == o && i !== !0) {
			var u = n.children("img");
			(0 == t.imageWidth || 0 == t.imageHeight) && ft.checkFillImageSize(u, t), "image" != l && 1 == Tt.slider_video_constantsize ? c(u, t) : wt.scaleImageFitParent(u, t.imageWidth, t.imageHeight, s, objPadding), pt.trigger(ht.events.AFTER_PUT_IMAGE, e)
			...
			var i = e.parent().parent(),
				n = ht.getSlideType(i),
				r = K(i),
				o = ht.getObjImagePadding(),
				a = ht.getScaleMode(i);
			_(r), i.data("isLoading", !1), ht.isSlideCurrent(i) && pt.trigger(ht.events.CURRENTSLIDE_LOAD_END), ft.onItemBigImageLoaded(null, e);
			var s = ft.getItem(t);
			"image" != n && 1 == Tt.slider_video_constantsize ? c(e, s) : wt.scaleImageFitParent(e, s.imageWidth, s.imageHeight, a, o), e.fadeTo(0, 1), pt.trigger(ht.events.AFTER_PUT_IMAGE, i)
		}));
		u && g(u, l)
	}
	function p(e, t) {
		try {
			...
			e.data("index", t.index), e.data("type", t.type), 1 == Tt.slider_enable_links && "image" == t.type && (t.link ? e.addClass("ug-slide-clickable") : e.removeClass("ug-slide-clickable")), h(e, t);
			var n = J(e);
			switch (t.type) {
			case "image":
				n.hide();
	...
	function f() {
		...
		var e = Et.getElement(),
			t = 0;
		(1 == Pt.isTextPanelSaparateHover || 1 == Tt.slider_textpanel_always_on) && (t = Tt.slider_controls_appear_duration), e.stop().fadeTo(t, 0), e.data("isHidden", !0)
	}
	function m() {
		if (!Et) return !1;
		if (0 == v()) return !1;
		var e = Et.getElement(),
			t = 0;
		(1 == Pt.isTextPanelSaparateHover || 1 == Tt.slider_textpanel_always_on) && (e.show(), Et.positionElements(), t = Tt.slider_controls_appear_duration), e.stop().show().fadeTo(t, 1), e.data("isHidden", !1)
	}
	function v() {
		var e = Et.getElement(),
			t = e.data("isHidden");
	...
	function b(e, t) {
		if (void 0 == t) var t = ht.getCurrentSlide();
		var i = ht.getSlideType(t);
		if (i != e) throw new Error("Wrong slide type: " + i + ", should be: " + e);
		return !0
	}
	function y() {
		var e = ht.getCurrentSlide(),
			t = ht.getSlideImage(e),
			i = wt.getElementSize(e),
			n = i.left,
			r = i.top;
		if (1 == Tt.slider_video_constantsize) {
			var o = wt.getElementSize(t);
			n += o.left, r += o.top
		} else n += Tt.slider_video_padding_left, r += Tt.slider_video_padding_top;
		yt.setPosition(n, r)
	}
	function w() {
		var e = Tt.slider_video_constantsize_width,
			t = Tt.slider_video_constantsize_height;
		yt.setSize(e, t);
		var i = yt.getObject();
		g(i)
	}
	function I(e, t, i) {
		pt.trigger(ht.events.TRANSITION_START);
		var n = Tt.slider_transition;
		switch (i && (n = i), ht.stopSlideAction(null, !0), n) {
		default:
		case "fade":
			S(t);
			break;
	...
	function E(e, t) {
		var i = ht.isAnimating();
		if (1 == i) return Pt.itemWaiting = t, !0;
		null != Pt.itemWaiting && (Pt.itemWaiting = null);
		var n = ht.getSlidesReference();
		switch (e) {
		case "right":
			p(n.objPrevSlide, t), l();
			var r = wt.getElementSize(n.objPrevSlide),
				o = -r.left;
			ht.switchSlideNums("right");
			break;
		case "left":
			p(n.objNextSlide, t), l();
			var a = wt.getElementSize(n.objNextSlide),
				o = -a.left;
			ht.switchSlideNums("left");
			break;
		default:
			throw new Error("wrong direction: " + e)
		}
		var s = Tt.slider_transition_speed,
			u = Tt.slider_transition_easing,
			d = {
				duration: s,
				easing: u,
				queue: !1,
				always: function() {
					if (ht.stopSlideAction(), yt.hide(), null != Pt.itemWaiting) {
						var e = q(Pt.itemWaiting);
						E(e, Pt.itemWaiting)
					} else ht.placeNabourItems(), pt.trigger(ht.events.TRANSITION_END)
				}
			};
		rt.animate({
			left: o + "px"
	...
	function T(e, t, i) {
		i ? e.fadeTo(Tt.slider_transition_speed, t, i) : e.fadeTo(Tt.slider_transition_speed, t)
	}
	function S(e, t, i) {
		if (!t) var t = !1;
		var n = ht.getSlidesReference();
		p(n.objNextSlide, e);
		var r = wt.getElementSize(n.objCurrentSlide);
		wt.placeElement(n.objNextSlide, r.left, r.top);
		var o = Pt.numCurrent;
		if (Pt.numCurrent = Pt.numNext, Pt.numNext = o, pt.trigger(ht.events.ITEM_CHANGED), n.objNextSlide.stop(!0), n.objCurrentSlide.stop(!0), 1 == t) n.objCurrentSlide.fadeTo(0, 0), n.objNextSlide.fadeTo(0, 1), ht.placeNabourItems(), pt.trigger(ht.events.TRANSITION_END), i !== !0 && yt.hide();
		else {
			if (n.objNextSlide.fadeTo(0, 0), T(n.objCurrentSlide, 0, function() {
				ht.placeNabourItems(), pt.trigger(ht.events.TRANSITION_END), i !== !0 && yt.hide()
			}), 1 == yt.isVisible()) {
				var a = yt.getObject();
				T(a, 0)
			}
	...
	function P() {
		1 == Tt.slider_fullscreen_button_mobilehide && vt && vt.hide(), 1 == Tt.slider_play_button_mobilehide && mt && mt.hide(), 1 == Tt.slider_zoompanel_mobilehide && gt && gt.getElement().hide()
	}
	function x() {
		1 == Tt.slider_fullscreen_button_mobilehide && vt && vt.show(), 1 == Tt.slider_play_button_mobilehide && mt && mt.show(), 1 == Tt.slider_zoompanel_mobilehide && gt && gt.getElement().show()
	}
	function j() {
		var e = ft.isMobileMode();
		e ? P() : x()
	}
	function C() {
		var e = nt.children(".ug-slider-control");
		return e
	}
	function A(e) {
		if (0 == wt.isTimePassed("sliderControlsToggle")) return !1;
		if (0 == Pt.isControlsVisible) return !1;
		if (!e) var e = !1;
		var t = C();
		e === !0 ? t.stop().fadeTo(0, 0).hide() : t.stop().fadeTo(Tt.slider_controls_appear_duration, 0, function() {
			t.hide()
		}), Pt.isControlsVisible = !1
	}
	function M(e) {
		if (0 == wt.isTimePassed("sliderControlsToggle")) return !1;
		if (1 == Pt.isControlsVisible) return !0;
		if (!e) var e = !1;
		var t = C();
		e === !0 ? t.stop().show() : (t.stop().show().fadeTo(0, 0), t.fadeTo(Tt.slider_controls_appear_duration, 1)), Pt.isControlsVisible = !0
	}
	function O() {
		0 == Pt.isControlsVisible ? M() : A()
	}
	function z(e) {
		if (e == Pt.currentControlsMode) return !1;
		switch (e) {
		case "image":
			gt && gt.getElement().show();
			break;
		case "video":
			gt && gt.getElement().hide();
			break;
		default:
			throw new Error("wrong controld mode: " + e)
		}
		Pt.currentControlsMode = e
	}
	function N() {
		var e = ft.getSelectedItem();
		ht.setItem(e);
		var t = e.index;
		bt && bt.setActive(t), Et && 0 == Pt.isTextPanelSaparateHover && m(), z("image" == e.type ? "image" : "video")
	}
	function k(e, t) {
		ft.selectItem(t)
	}
	function L(e) {
		return dt && 0 == dt.isTapEventOccured(e) ? !0 : void pt.trigger(ht.events.CLICK, e)
	}
	function R() {
		var e = ht.getCurrentSlide(),
			t = e.hasClass("ug-slide-clickable"),
			i = ht.getCurrentItem();
		return t ? (0 == Tt.slider_links_newpage ? location.href = i.link : window.open(i.link, "_blank"), !0) : void(0 == Tt.slider_controls_always_on && 1 == Tt.slider_controls_appear_ontap && 1 == ht.isCurrentSlideType("image") && (O(), Et && 1 == Tt.slider_textpanel_always_on && ht.isCurrentSlideType("image") && ht.isCurrentSlideImageFit() && m()))
	}
	function Q() {
		Et && ht.isCurrentSlideType("image") && 0 == ht.isCurrentSlideImageFit() && f()
	}
	function H() {
		M()
	}
	...
	function D(e) {
		var t = e.parent();
		ht.startSlideAction(t)
	}
	function F() {
		ft.isPlayMode() && ft.pausePlaying(), pt.trigger(ht.events.ACTION_START)
	}
	function W() {
		ft.isPlayMode() && ft.continuePlaying(), pt.trigger(ht.events.ACTION_END)
	}
	function B(e, t) {
		ot.data("index") == t && (objItem = ft.getItem(t), h(ot, objItem, !0)), at.data("index") == t && (objItem = ft.getItem(t), h(at, objItem, !0)), st.data("index") == t && (objItem = ft.getItem(t), h(st, objItem, !0))
	}
	function Y(e, t) {
		t = jQuery(t);
		var i = ht.getSlideImage(t),
			n = J(t),
			r = wt.getElementSize(i);
		wt.placeElement(n, "center", "middle", r.left, r.top, i)
	}
	function U(e) {
		var t = J(e);
		wt.addClassOnHover(t), wt.setButtonOnClick(t, D)
	}
	function X() {
		et.on(ft.events.ITEM_IMAGE_UPDATED, B), et.on(ft.events.ITEM_CHANGE, N), bt && jQuery(bt).on(bt.events.BULLET_CLICK, k), 1 == Tt.slider_enable_arrows && (wt.addClassOnHover(ut, "ug-arrow-hover"), wt.addClassOnHover(lt, "ug-arrow-hover"), ft.setNextButton(ut), ft.setPrevButton(lt)), 0 == Tt.slider_controls_always_on && nt.hover(H, G), nt.on("touchend click", L), pt.on(ht.events.CLICK, R), Et && 1 == Pt.isTextPanelSaparateHover && nt.hover(m, f), mt && (wt.addClassOnHover(mt, "ug-button-hover"), ft.setPlayButton(mt)), vt && (wt.addClassOnHover(vt, "ug-button-hover"), ft.setFullScreenToggleButton(vt)), _t && pt.on(ht.events.ZOOM_CHANGE, Q), gt && gt.initEvents(), yt.initEvents(), jQuery(yt).on(yt.events.SHOW, F), jQuery(yt).on(yt.events.HIDE, W), U(ot), U(at), U(st), pt.on(ht.events.AFTER_PUT_IMAGE, Y), nt.delegate(".ug-item-wrapper img", "click", function() {
			pt.trigger(ht.events.IMAGE_MOUSEENTER);
			 //sunyang  slide to click 
			// var src = jQuery('.oder_img').data('thumb');
			// console.log(src);
			// jQuery('.oder_img').click(function(){
			// 	window.open('ssdfsd');
			// })
					
		}), nt.delegate(".ug-item-wrapper img", "mouseleave", function(e) {  //sunyang  离开图片 触发
			var t = ht.isMouseInsideSlideImage(e);
			0 == t && pt.trigger(ht.events.IMAGE_MOUSELEAVE)
		})
	}
	function V() {
		var e;
		switch (Tt.slider_loader_type) {
		default:
		case 1:
			e = "ug-loader1";
			break;
		...
		return "black" == Tt.slider_loader_color && (e += " ug-loader-black"), e
	}
	function Z(e) {
		switch (e) {
		case 1:
	...
	var et, tt, it, nt, rt, ot, at, st, lt, ut, dt, _t, gt, ct, ht = this,
		pt = jQuery(ht),
		ft = new UniteGalleryMain,
		mt = null,
		vt = null,
		bt = null,
		yt = new UGVideoPlayer,
		wt = new UGFunctions,
		It = null,
		Et = null;
	this.events = {
	...
	var Tt = {
		slider_scale_mode: "",  //sunyang fill 填充  空 为默认
		...
		slider_zoom_mousewheel: !1,  //sunyang 幻灯片图片 滚轮开关 放大放小
	...
	this.switchSlideNums = function(e) {
		switch (pt.trigger(ht.events.BEFORE_SWITCH_SLIDES), e) {
		case "left":
			var t = Pt.numCurrent;
			Pt.numCurrent = Pt.numNext, Pt.numNext = Pt.numPrev, Pt.numPrev = t;
			break;
		case "right":
			var t = Pt.numCurrent;
			Pt.numCurrent = Pt.numPrev, Pt.numPrev = Pt.numNext, Pt.numNext = t;
			break;
		default:
			throw new Error("wrong direction: " + e)
		}
		pt.trigger(ht.events.ITEM_CHANGED)
	}, this.destroy = function() {
		pt.off(ht.events.AFTER_PUT_IMAGE), et.off(ft.events.ITEM_IMAGE_UPDATED), et.off(ft.events.ITEM_CHANGE), bt && jQuery(bt).on(bt.events.BULLET_CLICK), nt.off("mouseenter"), nt.off("mouseleave"), nt.off("touchend"), nt.off("click"), pt.off(ht.events.CLICK), _t && pt.off(ht.events.ZOOM_CHANGE), pt.off(ht.events.BEFORE_SWITCH_SLIDES), jQuery(yt).off(yt.events.SHOW), jQuery(yt).off(yt.events.HIDE), yt.destroy(), nt.undelegate(".ug-item-wrapper img", "mouseenter"), nt.undelegate(".ug-item-wrapper img", "mouseleave")
		...
		var e = ht.getSlidesReference(),
			t = wt.getElementSize(e.objCurrentSlide),
			i = -t.left,
			n = wt.getElementSize(rt);
		return i == n.left ? !0 : !1
	}, this.isAnimating = function() {
		var e = rt.is(":animated");
		return e
	}, this.isSlideCurrent = function(e) {
		var t = e.data("slidenum");
		return Pt.numCurrent == t ? !0 : !1
	}, this.isSlideHasItem = function(e) {
		var t = e.data("index");
		return void 0 === t || null === t ? !1 : !0
	}, this.getObjImagePadding = function() {
		var e = {
			padding_top: Tt.slider_image_padding_top,
			padding_bottom: Tt.slider_image_padding_bottom,
			padding_left: Tt.slider_image_padding_left,
			padding_right: Tt.slider_image_padding_right
		};
		return e
	}, this.getSlidesReference = function() {
		var e = {
			objPrevSlide: Z(Pt.numPrev),
			objNextSlide: Z(Pt.numNext),
			objCurrentSlide: Z(Pt.numCurrent)
		};
		return e
		...
		var e = ht.getCurrentItemIndex();
		if (-1 == e) return null;
		var t = ft.getItem(e);
		return t
	}, this.getSlideType = function(e) {
		void 0 == e && (e = ht.getCurrentSlide());
		var t = e.data("type");
		return t
	}, this.isMouseInsideSlideImage = function(e) {
		var t = ht.getSlideImage(),
			i = wt.getMousePosition(e);
		void 0 === i.pageX && (i = dt.getLastMousePos());
		var n = wt.getMouseElementPoint(i, t),
			r = wt.getElementSize(t);
		return isMouseInside = wt.isPointInsideElement(n, r)
	}, this.isCurrentSlideType = function(e) {
		var t = ht.getSlideType();
		return t == e ? !0 : !1
		...
		var i = ht.getSlidesReference(),
			n = i.objCurrentSlide.data("index"),
			r = e.index;
		if (r == n) return !0;
		var o = void 0 == n;
		if (o) p(i.objCurrentSlide, e), ht.placeNabourItems();
		else {
			var a = "left",
				s = ft.getNumItems();
			n == s - 1 && 0 == r ? a = "left" : 0 == n && r == s - 1 ? a = "right" : n > r && (a = "right"), I(a, e, t)
		}
		...
		e || (e = ht.getCurrentSlide()), t === !0 ? yt.pause() : yt.hide()
	}, this.startSlideAction = function(e) {
		e || (e = ht.getCurrentSlide());
		var t = $(e);
		if ("image" == t.type) return !0;
		switch (1 == Tt.slider_video_constantsize && w(), y(), yt.show(), t.type) {
		case "youtube":
			yt.playYoutube(t.videoid);
			break;
		case "vimeo":
			yt.playVimeo(t.videoid);
			break;
		case "html5video":
			yt.playHtml5Video(t.videoogv, t.videowebm, t.videomp4, t.urlImage);
			break;
		case "soundcloud":
			yt.playSoundCloud(t.trackid);
			break;
		case "wistia":
			yt.playWistia(t.videoid)
		}
	}, this.getScaleMode = function(e) {
		if (!e) var e = ht.getCurrentSlide();
		var t = ht.getSlideType(e);
		return "image" != t ? Tt.slider_scale_mode_media : Tt.slider_scale_mode == Tt.slider_scale_mode_fullscreen ? Tt.slider_scale_mode : 1 == ft.isFullScreen() ? Tt.slider_scale_mode_fullscreen : Tt.slider_scale_mode
	}, this.getObjects = function() {
		var e = {
			g_objSlider: nt,
			g_objInner: rt,
		...
		b("image", e);
		var t = ht.getSlideImage(e);
		if (0 == t.length) return !1;
		var i = wt.isImageFitParent(t);
		return i
	}, this.isCurrentImageInPlace = function() {
		var e = ht.getSlideImage();
		if (0 == e.length) return !1;
		var t = ht.getScaleMode(),
			i = ht.getObjImagePadding(),
			n = $(),
			r = e.parent(),
			o = wt.getImageInsideParentData(r, n.imageWidth, n.imageHeight, t, i),
			a = wt.getElementSize(e);
		return o.imageWidth == a.width ? !0 : !1
	}, this.isSlideActionActive = function() {
		return yt.isVisible()
	}, this.isSwiping = function() {
		if (!dt) return !1;
		var e = dt.isTouchActive();
		return e
	}, this.isPreloading = function() {
		var e = K();
		return e.is(":visible") ? !0 : !1
	}, this.setOptions = function(e) {
		ct && (e = wt.convertCustomPrefixOptions(e, ct, "slider")), Tt = jQuery.extend(Tt, e)
	}, this.setSize = function(e, t) {
		if (0 > e || 0 > t) return !0;
		var i = {};
		i.width = e + "px", i.height = t + "px", nt.css(i);
		var n = {};
		n.height = t + "px", n.top = "0px", n.left = "0px", rt.css(n);
		var r = {};
		r.height = t + "px", r.width = e + "px", ot.css(r), at.css(r), st.css(r);
		var o = e - Tt.slider_item_padding_left - Tt.slider_item_padding_right,
			s = t - Tt.slider_item_padding_top - Tt.slider_item_padding_bottom,
			d = {};
		d.width = o + "px", d.height = s + "px", d.top = Tt.slider_item_padding_top + "px", d.left = Tt.slider_item_padding_left + "px", nt.find(".ug-item-wrapper").css(d), Et && Et.setSizeByParent();
		var _ = ht.getSlideType();
		if ("image" != _ && 1 == Tt.slider_video_constantsize) w();
		else {
			var g = e - Tt.slider_video_padding_left - Tt.slider_video_padding_right,
				c = t - Tt.slider_video_padding_top - Tt.slider_video_padding_bottom;
			yt.setSize(g, c)
		}
		a(), u(ot), u(at), u(st), l()
	}, this.refreshSlideItems = function() {
		return 1 == ht.isAnimating() ? !0 : (u(ot), u(at), u(st), void l())
	}, this.isMouseOver = function() {
		return nt.ismouseover()
	}, this.setPosition = function(e, t) {
		wt.placeElement(nt, e, t)
	}, this.zoomIn = function() {
		return _t ? void _t.zoomIn() : !0
	}, this.zoomOut = function() {
		return _t ? void _t.zoomOut() : !0
	}, this.zoomBack = function() {
		return _t ? void _t.zoomBack() : !0
	}
}
function UGTextPanel() {
	...
	this.positionElements = function(t) {
		...
		u = e;
		var t = "<div class='ug-textpanel hide'>";
...
function UGZoomButtonsPanel() {
	...
	this.init = function(e, t) {
		...
		o = e;
		var t = "<div class='ug-slider-control ug-zoompanel hide ug-skin-" + g.slider_zoompanel_skin + "'>"; //sunyang  隐藏左侧控制按钮
		t += "<div class='ug-zoompanel-button ug-zoompanel-plus'></div>", t += "<div class='ug-zoompanel-button ug-zoompanel-minus ug-zoompanel-button-disabled'></div>", t += "<div class='ug-zoompanel-button ug-zoompanel-return ug-zoompanel-button-disabled'></div><div class='ug-zoompanel-button ug-zoompanel-button glyphicon glyphicon-eye-open' style='padding:4px;border:1px solid #a7a7a7;color:#a7a7a7;'></div>", t += "</div>", e.append(t), r = e.children(".ug-zoompanel"), a = r.children(".ug-zoompanel-plus"), s = r.children(".ug-zoompanel-minus"), l = r.children(".ug-zoompanel-return")
	}, this.getElement = function() {
		return r
...
function UGStripPanel() {
	function e(e, t) {
		...
		var n = T.getOptions(),
			r = n.gallery_skin;
		"" == j.strippanel_buttons_skin && (j.strippanel_buttons_skin = r), v = T.getElement(), x.init(T, M, I, j, E), T.initThumbsPanel("strip", j);
		var o = T.getObjects();
		P = o.g_objThumbs
	}
	function t() {
	...
	function n(e) {
		...
		x.setHtml(b), P.setHtml(b), 1 == j.strippanel_enable_buttons && (w = b.children("." + t), y = b.children("." + i)), r()
	}
	function r() {
	...
	function c() {
		if (!y) return !0;
		if (0 == P.isMoveEnabled()) return S.disableButton(w), S.disableButton(y), !0;
	...
	function p() {
		T.isLastItem() ? S.disableButton(y) : S.enableButton(y), T.isFirstItem() ? S.disableButton(w) : S.enableButton(w)
	}
	function f() {
		if (1 == M.isEventsInited) return !1;
		if (M.isEventsInited = !0, y) if (S.addClassOnHover(y, "ug-button-hover"), S.addClassOnHover(w, "ug-button-hover"), S.setButtonOnClick(w, g), S.setButtonOnClick(y, _), "advance_item" != j.strippanel_buttons_role) jQuery(P).on(P.events.STRIP_MOVE, h), m.on(T.events.SIZE_CHANGE, c);
		else {
			var e = T.getOptions();
	...
	this.destroy = function() {
		y && (S.destroyButton(y), S.destroyButton(w), jQuery(P).off(P.events.STRIP_MOVE), jQuery(T).off(T.events.ITEM_CHANGE), jQuery(T).off(T.events.SIZE_CHANGE)), x.destroy(), P.destroy()
	}, this.getOrientation = function() {
...
function UGTabs() {
	function e(e, t) {
		s = e, o = jQuery(s), l = jQuery.extend(l, t), a = jQuery(l.tabs_container + " .ug-tab")
	}
	function t() {
		r()
	}
	...
	function n() {
		var e = l.tabs_class_selected,
			t = jQuery(this);
		if (t.hasClass(e)) return !0;
		a.not(t).removeClass(e), t.addClass(e);
		var n = t.data("catid");
		return n ? void i(n) : !0
	}
	function r() {
	...
	var o, a, s = (jQuery(this), new UniteGalleryMain),
		l = (new UGFunctions, {
			tabs_container: "#ug_tabs",
			tabs_class_selected: "ug-tab-selected"
		});
	this.events = {}, this.init = function(t, i) {
		e(t, i)
	}, this.run = function() {
		t()
	}
...
function UGThumbsGeneral() {
	function e(e, t, i, n) {
		...
		i ? (n !== !0 && i.css(r), i.children(a).css(o)) : (I.children(".ug-thumb-wrapper").css(r), I.find(a).css(o))
	}
	function t(e, t, i, n) {
		if (!n) var n = !1;
	...
	function a() {
		...
		I.find(".ug-thumb-wrapper, .ug-thumb-wrapper .ug-thumb-border-overlay").css(e)
	}
	function s(e, t) {
		e.stop(!0).animate(t, {
	...
	function l(e) {
		1 == g(e) ? r(e, !0) : E.setThumbNormalStyle(e, !0)
	}
	function u(t, i) {
		if (1 == x.thumb_fixed_size) P.scaleImageCoverParent(i, t);
			...
			var n = P.getElementSize(i);
			P.placeElement(i, 0, 0), e(n.width, n.height, t)
		}
	...
	function c(t, i) {
		...
		e(n.width, n.height, i, !0), E.setThumbNormalStyle(i, !0)
	}
	function h(e) {
		return 1 == j.touchEnabled ? (objThumbs.off("mouseenter").off("mouseleave"), !0) : void(0 == g(e) && E.setThumbOverStyle(e))
	}
	function p(e) {
		return 1 == j.touchEnabled ? !0 : void(0 == g(e) && E.setThumbNormalStyle(e))
	}
	function f(e, t) {
		if (!t) var t = !1;
		var i = jQuery(e),
	...
	this.init = function(e, t) {
		b = e.getObjects(), S = e, v = jQuery(e), y = b.g_objWrapper, w = b.g_arrItems, x = jQuery.extend(x, t), j.isEffectBorder = x.thumb_border_effect, j.isEffectOverlay = x.thumb_color_overlay_effect, j.isEffectImage = x.thumb_image_overlay_effect
		...
		for (var n = 0; t > n; n++) {
			...
			if (1 == x.thumb_wrapper_as_link) {
				...
				var l = "";
				1 == x.thumb_link_newpage && r.link && (l = " target='_blank'");
				var a = "<a href='" + s + "'" + l + " class='ug-thumb-wrapper" + o + "'></a>"
			}
			var u = jQuery(a),
				d = r.objThumbImage;
			if (0 == j.customThumbs) {
				if (1 == x.thumb_show_loader && d) {
					var g = "ug-thumb-loader-dark";
					"bright" == x.thumb_loader_type && (g = "ug-thumb-loader-bright"), u.append("<div class='ug-thumb-loader " + g + "'></div>"), u.append("<div class='ug-thumb-error' style='display:none'></div>")
				}
				if (d) {
					if (d.addClass("ug-thumb-image"), 1 == x.thumb_image_overlay_effect) {
						var c = d.clone().appendTo(u);
						c.addClass("ug-thumb-image-overlay " + i).removeClass("ug-thumb-image"), c.fadeTo(0, 0), r.objImageOverlay = c
					}
					u.append(d)
				}
			}
			j.isEffectBorder && u.append("<div class='ug-thumb-border-overlay'></div>"), j.isEffectOverlay && u.append("<div class='ug-thumb-overlay'></div>"), I.append(u), j.customThumbs && j.funcSetCustomThumbHtml(u, r), w[n].objThumbWrapper = u
		}
		...
		if (1 == j.customThumbs && e.removeClass("ug-thumb-over"), j.isEffectBorder && t(e, x.thumb_border_width, x.thumb_border_color, r), j.isEffectOverlay) {
			var o = 1 == x.thumb_overlay_reverse ? !1 : !0;
			i(e, o, r)
		}
		...
		if (I.children(".ug-thumb-wrapper").each(function() {
			var e = jQuery(this);
			E.setThumbNormalStyle(e, !0)
			...
			I.find(".ug-thumb-wrapper .ug-thumb-overlay").css(t)
		}
		...
		e.removeClass("ug-thumb-selected"), E.setThumbNormalStyle(e)
	}, this.setOptions = function(e) {
		x = jQuery.extend(x, e)
		...
		j.funcSetCustomThumbHtml = e, -1 == jQuery.inArray("overlay", t) && (j.isEffectOverlay = !1), -1 == jQuery.inArray("border", t) && (j.isEffectBorder = !1), j.isEffectImage = !1
		...
		var t = e.children(".ug-thumb-image");
		return t
		...
		return I.children(".ug-thumb-wrapper")
		...
		var e = I.find(".ug-thumb-wrapper");
		e.on("touchstart", function() {
			j.touchEnabled = !0, e.off("mouseenter").off("mouseleave")
		}), y.on(C.eventSizeChange, c), e.hover(function() {
			var e = jQuery(this);
			h(e)
		}, function() {
			var e = jQuery(this);
		...
		I.find(".ug-thumb-wrapper").hide()
	}
}
function UGThumbsGrid() {
	function e(e, t, i) {
		N = e.getObjects(), D = e, z = jQuery(e), k = N.g_objWrapper, L = N.g_arrItems, i === !0 && (U.isTilesMode = !0), U.numThumbs = L.length, u(t), U.isNavigationVertical = "top" == Y.grid_panes_direction || "bottom" == Y.grid_panes_direction, 1 == U.isTilesMode ? (B.setFixedMode(), B.setApproveClickFunction(S), B.init(e, Y), W = B.getObjThumbs()) : (t.thumb_fixed_size = !0, W.init(e, t))
	}
	function t(e) {
		var t = k;
		e && (t = e), t.append("<div class='ug-thumbs-grid'><div class='ug-thumbs-grid-inner'></div></div>"), R = t.children(".ug-thumbs-grid"), Q = R.children(".ug-thumbs-grid-inner"), 1 == U.isTilesMode ? B.setHtml(Q) : W.setHtmlThumbs(Q)
	}
	function n() {
		if (0 == U.isHorizontal) {
	...
	function r() {
		...
		if (n(), 1 == U.isFirstTimeRun && (1 == U.isTilesMode ? (s(), B.run()) : (W.setHtmlProperties(), s(), W.loadThumbsImages()), O()), c(), 1 == U.isFirstTimeRun && U.isTilesMode) {
			var t = W.getThumbs();
			t.each(function(e, t) {
				k.trigger(U.eventSizeChange, jQuery(t))
			}), t.fadeTo(0, 1)
		}
		null != e && l(e.index), G.trigger(H.events.PANE_CHANGE, U.currentPane), U.isFirstTimeRun = !1
	}
	function o() {
		var e = Q.children(".ug-thumb-wrapper"),
			...
			i = t.outerHeight(),
			n = U.gridWidth,
			r = Y.grid_num_rows * i + (Y.grid_num_rows - 1) * Y.grid_space_between_rows + 2 * Y.grid_padding;
		U.gridHeight = r, F.setElementSize(R, n, r), F.setElementSize(Q, n, r), U.innerWidth = n, U.innerHeight = r
	}
	function a() {
		var e = Q.children(".ug-thumb-wrapper"),
			t = jQuery(e[0]),
			i = t.outerWidth(),
			n = Y.grid_num_cols * i + (Y.grid_num_cols - 1) * Y.grid_space_between_cols + 2 * Y.grid_padding,
			r = U.gridHeight;
		U.gridWidth = n, F.setElementSize(R, n, r), F.setElementSize(Q, n, r), U.innerWidth = n, U.innerHeight = r
	}
	function s() {
	...
	function l(e) {
		var t = I(e);
		return -1 == t ? !1 : void H.gotoPane(t, "scroll")
	}
	function u(e) {
		Y = jQuery.extend(Y, e), W.setOptions(e)
	}
	function d() {
		var e = Q.children(".ug-thumb-wrapper"),
			t = 0,
		...
		Q.width(U.innerWidth), 1 == U.isMaxHeight && 1 == U.numPanes && (U.gridHeight = s, R.height(s))
	}
	function _() {
		var e = Q.children(".ug-thumb-wrapper"),
			t = 0,
		...
		for (i = 0; l > i; i++) {
			...
			var d = u.outerWidth(),
				_ = u.outerHeight();
			t += d + Y.grid_space_between_cols;
			var g = n + _;
			g > r && (r = g), o++, o >= Y.grid_num_cols && (n += _ + Y.grid_space_between_rows, t = a, o = 0), 1 == U.numPanes && U.numThumbsInPane++, g = n + _;
			var c = s + U.gridHeight;
			g > c && (1 == U.isMaxHeight && 1 == U.numPanes && (U.gridHeight = r, R.height(U.gridHeight), c = U.gridHeight), n = c + Y.grid_space_between_rows, s = n, a = 0, t = a, o = 0, l - 1 > i && (U.numPanes++, U.arrPanes.push(n)))
		}
		Q.height(r), U.innerHeight = r, 1 == U.isMaxHeight && 1 == U.numPanes && (U.gridHeight = r, R.height(r))
	}
	function g() {
		var e = Q.children(".ug-thumb-wrapper"),
			t = Y.grid_padding,
			...
			l = 0,
			u = 0;
		U.innerWidth = 0, U.numPanes = 1, U.arrPanes = [], U.numThumbsInPane = 0, U.arrPanes.push(t - Y.grid_padding);
		var d = e.length;
		for (i = 0; d > i; i++) {
			var _ = jQuery(e[i]),
				g = _.outerWidth(),
				c = _.outerHeight();
			o - t + g > U.gridWidth && (u++, r = 0, u >= Y.grid_num_rows ? (u = 0, t = o, l = 0, r = n, 1 == U.numPanes && (U.gridWidth = a + Y.grid_padding, R.width(U.gridWidth)), U.numPanes++, U.arrPanes.push(t - Y.grid_padding)) : (o = t, r = l + Y.grid_space_between_rows)), F.placeElement(_, o, r);
			var h = o + g;
			h > a && (a = h);
			var p = r + c;
			p > l && (l = p), p > s && (s = p);
			var h = a + g;
			h > U.innerWidth && (U.innerWidth = h), o += g + Y.grid_space_between_cols, 1 == U.numPanes && U.numThumbsInPane++
		}
		U.innerWidth = a, U.innerHeight = l, Q.width(U.innerWidth), Q.height(U.innerHeight), 1 == U.numPanes && (U.gridWidth = a + Y.grid_padding, U.gridHeight = s + Y.grid_padding, R.width(U.gridWidth), R.height(U.gridHeight))
	}
	function c() {
	...
	function m(e) {
		...
		return 0 == t ? !1 : void Q.stop(!0).animate(t, {
			duration: Y.grid_transition_duration,
			easing: Y.grid_transition_easing,
			queue: !1
		})
	}
	function v() {
	...
	function j() {
		if (0 == Y.grid_vertical_scroll_ondrag) return !1;
	...
	function C(e) {
		...
		0 == Y.grid_carousel && r > 0 && "prev" == o && (r /= 3), 0 == Y.grid_carousel && -a > r && "next" == o && (r = t.startInnerPos + n / 3), f(r)
	}
	function A(e) {
		if (0 == U.touchActive) return !0;
		F.updateStoredEventData(e, U.storedEventID);
		var t = F.getStoredEventData(U.storedEventID, U.isNavigationVertical);
		if (U.touchActive = !1, 0 == T()) return v(), !0;
		var i = w(),
			n = i - t.startInnerPos,
			r = n > 0 ? "prev" : "next";
		"next" == r ? 0 == Y.grid_carousel && H.isLastPane() ? v() : H.nextPane() : 0 == Y.grid_carousel && H.isFirstPane() ? v() : H.prevPane()
	}
	function M() {
		var e = D.getSelectedItem();
	...
	function O() {
		if (0 == U.isTilesMode) {
			...
			e.on("click touchend", P), z.on(D.events.ITEM_CHANGE, M)
		} else B.initEvents();
		R.bind("mousedown touchstart", x), jQuery("body").bind("mousemove touchmove", C), jQuery(window).add("body").bind("mouseup touchend", A)
	}
	var z, N, k, L, R, Q, H = this,
		G = jQuery(this),
	...
	this.destroy = function() {
		...
		R.unbind("mousedown"), R.unbind("touchstart"), jQuery("body").unbind("mousemove"), jQuery("body").unbind("touchmove"), jQuery(window).add("body").unbind("touchend"), jQuery(window).add("body").unbind("mouseup"), G.off(H.events.PANE_CHANGE)
		...
		if (1 == U.isTilesMode) var t = Y.tile_height;
		else var i = W.getOptions(),
			t = i.thumb_height;
		var n = W.getNumThumbs(),
			r = Math.ceil(n / Y.grid_num_cols),
			o = r * t + (r - 1) * Y.grid_space_between_rows,
			a = Math.ceil(o / e);
		return a
	}, this.getNumPanesEstimationByWidth = function(e) {
		if (U.isTilesMode) var t = Y.tile_width;
		else var i = W.getOptions(),
			t = i.thumb_width;
		var n = W.getNumThumbs(),
			r = Math.ceil(n / Y.grid_num_rows),
			o = r * t + (r - 1) * Y.grid_space_between_cols,
			a = Math.ceil(o / e);
		return a
		...
		var t = W.getNumThumbs(),
			i = F.getNumItemsInSpace(e, Y.tile_width, Y.grid_space_between_cols),
			n = Math.ceil(t / i);
		n > Y.grid_num_rows && (n = Y.grid_num_rows);
		var r = F.getSpaceByNumItems(n, Y.tile_height, Y.grid_space_between_rows);
		return r += 2 * Y.grid_padding
	}, this.getElement = function() {
		return R
	}, this.getSize = function() {
		...
		var t = -U.arrPanes[e];
		U.currentPane = e, m(t), G.trigger(H.events.PANE_CHANGE, e)
	}, this.nextPane = function() {
		var e = U.currentPane + 1;
		if (e >= U.numPanes) {
			if (0 == Y.grid_carousel) return !0;
			e = 0
		}
		H.gotoPane(e, "next")
	}, this.prevPane = function() {
		var e = U.currentPane - 1;
		return 0 > e && (e = U.numPanes - 1, 0 == Y.grid_carousel) ? !1 : void H.gotoPane(e, "prev")
	}, this.attachNextPaneButton = function(e) {
		return F.setButtonOnClick(e, H.nextPane), 1 == Y.grid_carousel ? !0 : (H.isLastPane() && e.addClass("ug-button-disabled"), void G.on(H.events.PANE_CHANGE, function() {
			H.isLastPane() ? e.addClass("ug-button-disabled") : e.removeClass("ug-button-disabled")
		}))
	}, this.attachPrevPaneButton = function(e) {
		return F.setButtonOnClick(e, H.prevPane), 1 == Y.grid_carousel ? !0 : (H.isFirstPane() && e.addClass("ug-button-disabled"), void G.on(H.events.PANE_CHANGE, function() {
			H.isFirstPane() ? e.addClass("ug-button-disabled") : e.removeClass("ug-button-disabled")
		}))
	}, this.attachBullets = function(e) {
		e.setActive(U.currentPane), jQuery(e).on(e.events.BULLET_CLICK, function(t, i) {
			H.gotoPane(i, "theme"), e.setActive(i)
		}), jQuery(H).on(H.events.PANE_CHANGE, function(t, i) {
			e.setActive(i)
		})
	}, this.getObjTileDesign = function() {
		return B
...
function UGThumbsStrip() {
	function e(e, i) {
		E = e.getObjects(), M = e, I = jQuery(e), T = E.g_objWrapper, S = E.g_arrItems, k = jQuery.extend(k, i), z = k.strip_vertical_type, 1 == z && (k = jQuery.extend(k, Q), k = jQuery.extend(k, i), i.thumb_resize_by = "width"), N.init(e, i), t()
	}
	function t() {
		var e = N.getOptions();
		L.isNotFixedThumbs = e.thumb_fixed_size === !1, z = k.strip_vertical_type
	}
	function n() {
		N.setHtmlProperties(), r(), s(), a(), 0 == L.isRunOnce && (1 == k.strip_control_touch && (C = new UGTouchThumbsControl, C.init(A)), 1 == k.strip_control_avia && (j = new UGAviaControl, j.init(A)), h(), N.loadThumbsImages(), v()), L.isRunOnce = !0
	}
	function r() {
		var e = x.children(".ug-thumb-wrapper"),
			t = jQuery(e[0]),
			i = t.outerWidth(),
			n = t.outerHeight(),
			r = N.getOptions();
		0 == z ? (R.thumbSize = i, R.thumbSecondSize = 1 == r.thumb_fixed_size ? n : r.thumb_height, R.stripSize = P.width(), R.stripInnerSize = x.width()) : (R.thumbSize = n, R.thumbSecondSize = 1 == r.thumb_fixed_size ? i : r.thumb_width, R.stripSize = P.height(), R.stripInnerSize = x.height())
	}
	function o(e) {
		0 == z ? x.width(e) : x.height(e), R.stripInnerSize = e, h()
	}
	function a() {
		var e = x.children(".ug-thumb-wrapper"),
			t = 0,
		...
		for (i = 0; i < e.length; i++) {
			var r = jQuery(e[i]);
			if (1 == L.isNotFixedThumbs) {
				if (objItem = N.getItemByThumb(r), 0 == objItem.isLoaded) continue;
				r.show()
			}
			O.placeElement(r, t, n), 0 == z ? t += r.outerWidth() + k.strip_space_between_thumbs : n += r.outerHeight() + k.strip_space_between_thumbs
		}
		if (0 == z) var a = t - k.strip_space_between_thumbs;
		else var a = n - k.strip_space_between_thumbs;
		o(a)
	}
	function s() {
		if (0 == z) {
	...
	function h() {
		var e = b();
		1 == e ? (j && j.enable(), C && C.enable()) : (j && j.disable(), C && C.disable())
	}
	function p() {
		return b() ? !1 : void(0 == z ? O.placeElement(x, k.strip_thumbs_align, 0) : O.placeElement(x, 0, k.strip_thumbs_align))
	}
	function f(e) {
		if (A.isTouchMotionActive()) {
			var t = C.isSignificantPassed();
			if (1 == t) return !0
		}
	...
	function m() {
		clearTimeout(L.handle), L.handle = setTimeout(function() {
			a()
		}, 50)
	}
	function v() {
		N.initEvents();
		var e = P.find(".ug-thumb-wrapper");
		e.on("click touchend", function() {
			var e = jQuery(this);
			f(e)
		}), I.on(M.events.ITEM_CHANGE, function() {
			var e = M.getSelectedItem();
			N.setThumbSelected(e.objThumbWrapper), _(e.objThumbWrapper)
		}), L.isNotFixedThumbs && jQuery(N).on(N.events.AFTERPLACEIMAGE, m)
	}
	function b() {
		return 0 == z ? x.width() > P.width() ? !0 : !1 : x.height() > P.height() ? !0 : !1
	}
	function y() {
		var e = {},
	...
	function w(e) {
		var t = {},
			i = e.position();
		return 0 == z ? (t.min = i.left, t.max = i.left + R.thumbSize) : (t.min = i.top, t.max = i.top + R.thumbSize), t
	}
	var I, E, T, S, P, x, j, C, A = this,
	...
	this.setHtml = function(e) {
		...
		e.append("<div class='ug-thumbs-strip'><div class='ug-thumbs-strip-inner'></div></div>"), P = e.children(".ug-thumbs-strip"), x = P.children(".ug-thumbs-strip-inner"), N.setHtmlThumbs(x), 1 == L.isNotFixedThumbs && N.hideThumbs()
	}, this.destroy = function() {
		var e = P.find(".ug-thumb-wrapper");
		e.off("click"), e.off("touchend"), I.off(M.events.ITEM_CHANGE), jQuery(N).off(N.events.AFTERPLACEIMAGE), C && C.destroy(), j && j.destroy(), N.destroy()
		...
		var t, i = 0;
		return t = 0 == z ? -(x.width() - P.width()) : -(x.height() - P.height()), e > i && (e = i), t > e && (e = t), e
		...
		0 == t ? (x.css(i), A.triggerStripMoveEvent()) : (A.triggerStripMoveEvent(), x.stop(!0).animate(i, {
		...
		if (!C) return !1;
		var e = C.isTouchActive();
		return e
	}, this.isItemThumbVisible = function(e) {
		var t = e.objThumbWrapper,
			i = t.position(),
			n = -1 * A.getInnerStripPos();
		if (0 == z) var r = n + P.width(),
			o = i.left,
			a = i.left + t.width();
		else var r = n + P.height(),
			o = i.top,
			a = i.top + t.height();
		var s = !1;
		return a >= n && r >= o && (s = !0), s
	}, this.getInnerStripPos = function() {
		return 0 == z ? x.position().left : x.position().top
	}, this.getInnerStripLimits = function() {
		var e = {};
		return e.maxPos = 0, e.minPos = 0 == z ? -(x.width() - P.width()) : -(x.height() - P.height()), e
		...
		if (0 == z) throw new Error("setSizeVertical error, the strip size is not vertical");
		var t = R.thumbSecondSize,
			i = {};
		i.width = t + "px", i.height = e + "px", P.css(i);
		var n = {};
		n.width = t + "px", n.left = "0px", n.top = "0px", x.css(n), L.is_placed = !0, h()
	}, this.setSizeHorizontal = function(e) {
		if (0 == z) throw new Error("setSizeHorizontal error, the strip size is not horizontal");
		var t = R.thumbSecondSize,
			i = {};
		i.width = e + "px", i.height = t + "px", P.css(i);
		var n = {};
		n.height = t + "px", n.left = "0px", n.top = "0px", x.css(n), L.is_placed = !0, h()
	}, this.setPosition = function(e, t, i, n) {
		O.placeElement(P, e, t, i, n)
	}, this.resize = function(e) {
		0 == z ? P.width(e) : P.height(e), R.stripSize = e, h(), c(), p(), g()
	}, this.setThumbUnselected = function(e) {
		...
		var e = N.getOptions(),
			...
			i = {
				...
				g_objStripInner: x,
				g_aviaControl: j,
				g_touchThumbsControl: C,
				isVertical: z,
				g_options: t
			};
		return i
	}, this.getSizeAndPosition = function() {
		var e = O.getElementSize(P);
		return e
	}, this.getHeight = function() {
		var e = P.outerHeight();
		return e
...
function UGTileDesign() {
	function e(e, n) {
		A = e, T = jQuery(e);
		var r = A.getObjects();
		P = r.g_objWrapper, x = A.getArrItems(), z = jQuery.extend(z, N), z = jQuery.extend(z, n), t(), O.init(e, z);
		var o = {};
		O.setCustomThumbs(i, ["overlay"], o);
		var a = O.getOptions();
		z = jQuery.extend(z, a), k.isSaparateIcons = !M.isRgbaSupported()
	}
	function t() {
	...
	function i(e, t) {
		...
		1 == k.isFixedMode && (e.fadeTo(0, 0), M.setElementSize(e, z.tile_width, z.tile_height), e.addClass("ug-tile-fixed"));
		var n = {};
		...
		if (z.tile_enable_icons) {
			...
			if (t.link && 1 == z.tile_show_link_icon || 1 == z.tile_as_link) if (0 == z.tile_as_link) {
				var s = "";
			...
			var l = k.isSaparateIcons;
			if (0 == l && "image" != t.type && 1 == z.tile_videoplay_icon_always_on && (l = !0), l) var u = e;
			else var u = e.children(".ug-thumb-overlay");
			u.append(o);
			var d = u.children("." + a);
			0 == d.length ? d = null : d.hide();
			var _ = u.children(".ug-icon-link");
			0 == _.length ? _ = null : _.hide(), _ || 1 != z.tile_enable_action || e.addClass("ug-tile-clickable")
		...
		if (1 == z.tile_enable_image_effect) {
			var g = "<div class='ug-tile-image-overlay' style='display:none'>",
				c = " ug-" + z.tile_image_effect_type + "-effect";
			g += "<img src='" + t.urlThumb + "' alt='" + t.title + "' class='" + c + "'>", g += "</div>", e.append(g)
		}
		if (1 == z.tile_enable_textpanel) {
			var h = new UGTextPanel;
			h.init(A, z, "tile"), h.appendHTML(e);
			var p = t.title;
			...
			h.setTextPlain(p, ""), 0 == z.tile_textpanel_always_on && h.getElement().fadeTo(0, 0), e.data("objTextPanel", h)
		}
	}
	function n(e) {
	...
	function _(e) {
		var t = (j.getItemByTile(e), l(e)),
			i = s(e),
			u = M.getElementSize(e),
			d = n(e),
			_ = j.getTileImage(e),
			g = r(e);
		1 == z.tile_enable_image_effect && M.setElementSize(d, u.width - k.tileInnerReduce, u.height - k.tileInnerReduce), k.isFixedMode && (0 == z.tile_enable_image_effect ? M.scaleImageCoverParent(_, e) : (M.scaleImageCoverParent(g, d), M.cloneElementSizeAndPos(g, _), setTimeout(function() {
			M.cloneElementSizeAndPos(g, _)
		}, 500)));
		var c = o(e);
		if (1 == z.tile_enable_textpanel && c && (c.refresh(!1, !0), (1 == z.tile_textpanel_always_on || "fade" == z.tile_textpanel_appear_type) && c.positionPanel()), t || i) {
			var h = 0;
			if (1 == z.tile_enable_textpanel) {
				var p = a(e),
					f = M.getElementSize(p);
				f.height > 0 && (h = Math.floor(f.height / 2 * -1))
			}
		}
		if (t && i) {
			var m = M.getElementSize(t),
				v = M.getElementSize(i),
				b = z.tile_space_between_icons,
				y = m.width + b + v.width,
				w = Math.floor((u.width - y) / 2);
			b > w && (b = Math.floor((u.width - m.width - v.width) / 3), y = m.width + b + v.width, w = Math.floor((u.width - y) / 2)), M.placeElement(t, w, "middle", 0, h), M.placeElement(i, w + m.width + b, "middle", 0, h)
		} else t && M.placeElement(t, "center", "middle", 0, h), i && M.placeElement(i, "center", "middle", 0, h);
		t && t.show(), i && i.show()
	}
	function g(e, t) {
		var i = (j.getItemByTile(e), n(e)),
			r = z.thumb_transition_duration;
		if (0 == z.tile_image_effect_reverse) {
			var o = j.getTileImage(e);
	...
	function h(e, t, i) {
		var n = z.thumb_transition_duration;
		i && i === !0 && (n = 0);
		var r = l(e),
			o = s(e),
			a = t ? 1 : 0;
	...
	function p(e, t) {
		if (t = jQuery(t), z.tile_enable_image_effect && g(t, !0), 1 == z.tile_enable_textpanel && 0 == z.tile_textpanel_always_on && c(t, !0), k.isSaparateIcons && 1 == z.tile_enable_icons) {
			var i = 1 == z.thumb_overlay_reverse,
				n = j.getItemByTile(t);
			(1 != z.tile_videoplay_icon_always_on || "image" == n.type) && h(t, i, !1)
		}
	}
	function f(e, t) {
		if (t = jQuery(t), z.tile_enable_image_effect && g(t, !1), 1 == z.tile_enable_textpanel && 0 == z.tile_textpanel_always_on && c(t, !1), k.isSaparateIcons && 1 == z.tile_enable_icons) {
			var i = 1 == z.thumb_overlay_reverse ? !1 : !0;
			h(t, i, !1)
		}
	}
	function m(e) {
	...
	function v(e, t, i) {
		return t = jQuery(t), 1 == k.isFixedMode && t.data("image_placed") !== !0 && i !== !0 ? !0 : void _(t)
	}
	function b(e, t, i) {
		_(t), i.fadeTo(0, 1), t.data("image_placed", !0)
	}
	function y(e) {
		return 1 == d(e) ? (C.trigger(j.events.TILE_CLICK, e), !0) : void(0 == u(e) && (m(e), O.setThumbOverStyle(e)))
	}
	function w(e) {
		var t = jQuery(this),
			i = t.prop("tagName").toLowerCase(),
			n = !0;
		if (k.funcParentApproveClick && 0 == k.funcParentApproveClick() && (n = !1), "a" == i) 0 == n && e.preventDefault();
		else if (0 == u(t)) 1 == n && y(t);
		else {
			if (0 == d(t)) return !0;
			1 == n && C.trigger(j.events.TILE_CLICK, t)
		}
	}
	function I(e) {
		e.stopPropagation();
		var t = jQuery(this).parents(".ug-tile"),
			i = !0;
		return k.funcParentApproveClick && 0 == k.funcParentApproveClick() && (i = !1), 0 == u(t) ? (y(t), !0) : 1 == i ? (C.trigger(j.events.TILE_CLICK, t), !1) : void 0
	}
	function E(e) {
		var t = jQuery(this).parents(".ug-tile");
		k.funcParentApproveClick && 0 == k.funcParentApproveClick() && e.preventDefault(), 0 == u(t) && 0 == z.tile_as_link && (e.preventDefault(), y(t))
	}
	var T, S, P, x, j = this,
		C = jQuery(this),
	...
	this.loadTileImage = function(e) {
		...
		O.initEvents(), jQuery(O).on(O.events.SETOVERSTYLE, p), jQuery(O).on(O.events.SETNORMALSTYLE, f), jQuery(O).on(O.events.PLACEIMAGE, b), P.on(k.eventSizeChange, v), S.delegate(".ug-tile .ug-button-play", "click", I), S.delegate(".ug-tile", "click", w), S.delegate(".ug-tile .ug-icon-link", "click", E)
	}, this.destroy = function() {
		if (jQuery(O).off(O.events.SETOVERSTYLE), jQuery(O).off(O.events.SETNORMALSTYLE), jQuery(O).off(O.events.PLACEIMAGE), P.off(k.eventSizeChange), 1 == z.tile_enable_textpanel) {
			var e = O.getThumbs();
		...
		if (1 == k.isFixedMode) {
			if (t) {
				...
				i = z.tile_height;
			M.setElementSize(e, t, i), j.triggerSizeChangeEvent(e, !0)
		} else {
			var n = {},
				r = {};
			null !== t && (n.width = t + "px", r.width = t - k.tileInnerReduce + "px"), null !== i && (n.height = i + "px", r.height = i - k.tileInnerReduce + "px"), e.css(n), 1 == z.tile_enable_textpanel && 1 == z.tile_textpanel_always_on && t && j.resizeTileTextPanel(e, t - k.tileInnerReduce), 1 == z.tile_enable_image_effect && e.find(".ug-tile-image-overlay").css(r)
		}
		...
		var i = o(e);
		if (!i) return !1;
		var n = M.getElementSize(e);
		return t < n.width ? !1 : void i.refresh(!1, !0, t)
	}, this.setAllTilesWidth = function(e) {
		var t = O.getThumbs();
		t.css("width", e + "px");
		var i = e - k.tileInnerReduce;
		if (1 == z.tile_enable_textpanel && 1 == z.tile_textpanel_always_on) for (var n = 0; n < t.length; n++) {
			var r = jQuery(t[n]);
			j.resizeTileTextPanel(r, i)
		}
		1 == z.tile_enable_image_effect && 0 == z.tile_image_effect_reverse && t.find(".ug-tile-image-overlay").css("width", i + "px")
	}, this.getTileHeightByWidth = function(e, t) {
		var i = j.getItemByTile(e),
			n = t * i.thumbRatioByHeight;
		return n = Math.floor(n)
	}, this.triggerSizeChangeEvent = function(e, t) {
		if (!e) return !1;
		if (!t) var t = !1;
		P.trigger(k.eventSizeChange, [e, t])
	}, this.triggerSizeChangeEventAllTiles = function(e) {
		var t = O.getThumbs();
		t.each(function() {
			var t = jQuery(this);
			j.triggerSizeChangeEvent(t, e)
		})
		...
		var e = O.getThumbs();
		1 == z.tile_enable_image_effect && 0 == z.tile_image_effect_reverse && e.children(".ug-thumb-image").fadeTo(0, 0), O.setHtmlProperties(), 1 == k.isFixedMode && (e.children(".ug-thumb-image").fadeTo(0, 0), O.loadThumbsImages())
...
function UGTiles() {
	function e(e, i) {
		g_objects = e.getObjects(), j = e, I = jQuery(e), E = g_objects.g_objWrapper, S = g_objects.g_arrItems, z = jQuery.extend(z, i), A.init(e, z), M = A.getObjThumbs(), t()
	}
	function t() {
		z.tiles_min_columns < 1 && (z.tiles_min_columns = 1), 0 != z.tiles_max_columns && z.tiles_max_columns < z.tiles_min_columns && (z.tiles_max_columns = z.tiles_min_columns)
	}
	function i(e) {
		if (!e) var e = E;
		T = e;
		var t = z.tiles_type;
		e.addClass("ug-tiletype-" + t), A.setHtml(e), e.children(".ug-thumb-wrapper").hide()
	}
	function n() {
		if (1 == z.tiles_enable_transition) {
			T.addClass("ug-tiles-transit");
			var e = A.getOptions();
			1 == e.tile_enable_image_effect && 0 == e.tile_image_effect_reverse && T.addClass("ug-tiles-transit-overlays"), N.isTransActive = !0
		}
	}
	function r() {
		return C.getElementSize(T).width
	}
	function o() {
		return 0 == N.isTransActive ? !1 : void A.disableEvents()
	}
	function a() {
		1 == N.isTransActive ? (setTimeout(function() {
			A.enableEvents(), A.triggerSizeChangeEventAllTiles()
		}, 800), N.handle && clearTimeout(N.handle), N.handle = setTimeout(function() {
			A.triggerSizeChangeEventAllTiles(), N.handle = null
		}, 2e3)) : A.triggerSizeChangeEventAllTiles()
	}
	function s() {
		O.colWidth = (O.availWidth - O.colGap * (O.numCols - 1)) / O.numCols, O.colWidth = Math.floor(O.colWidth), O.totalWidth = C.getSpaceByNumItems(O.numCols, O.colWidth, O.colGap)
	}
	function l() {
		if (O.colWidth = z.tiles_col_width, O.minCols = z.tiles_min_columns, O.colGap = 0 == j.isMobileMode() ? z.tiles_space_between_cols : z.tiles_space_between_cols_mobile, O.galleryWidth = r(), O.availWidth = O.galleryWidth, 1 == z.tiles_include_padding && (O.availWidth = O.galleryWidth - 2 * O.colGap), 1 == z.tiles_exact_width) O.numCols = C.getNumItemsInSpace(O.availWidth, O.colWidth, O.colGap), O.maxCols > 0 && O.numCols > O.maxCols && (O.numCols = O.maxCols), O.numCols < O.minCols ? (O.numCols = O.minCols, s()) : O.totalWidth = O.numCols * (O.colWidth + O.colGap) - O.colGap;
		else {
			var e = C.getNumItemsInSpaceRound(O.availWidth, O.colWidth, O.colGap);
			e < O.minCols ? e = O.minCols : 0 != O.maxCols && e > O.maxCols && (e = O.maxCols), O.numCols = e, s()
		}
		switch (z.tiles_align) {
		case "center":
		default:
			O.addX = Math.round((O.galleryWidth - O.totalWidth) / 2);
			break;
		case "left":
			O.addX = 0;
			break;
		case "right":
			O.addX = O.galleryWidth - O.totalWidth
		}
		for (O.maxColHeight = 0, O.arrPosx = [], col = 0; col < O.numCols; col++) {
			var t = C.getColX(col, O.colWidth, O.colGap);
			O.arrPosx[col] = t + O.addX
		}
		O.colHeights = [0]
	}
	function u() {
		...
		for (col = 0; col < O.numCols; col++) {
			if (void 0 == O.colHeights[col] || 0 == O.colHeights[col]) return col;
			O.colHeights[col] < t && (e = col, t = O.colHeights[col])
		}
		return e
	}
	function d(e, t, i, n) {
		if (null === n || "undefined" == typeof n) var n = u();
		var r = 0;
		void 0 !== O.colHeights[n] && (r = O.colHeights[n]);
		var o = A.getTileHeightByWidth(e, O.colWidth),
			a = O.arrPosx[n];
		C.placeElement(e, a, r);
		var s = r + o;
		O.colHeights[n] = s + O.colGap, O.maxColHeight < s && (O.maxColHeight = s), 1 == t && e.show(), 1 == i && T.height(O.maxColHeight)
	}
	function _(e) {
		e || (e = !1), l();
		var t = M.getThumbs();
		o(), A.setAllTilesWidth(O.colWidth);
		for (var i = 0; i < t.length; i++) {
			var n = jQuery(t[i]),
				r = void 0;
			1 == z.tiles_keep_order && (r = C.getColByIndex(O.numCols, i)), d(n, e, !1, r)
		}
		a();
		var s = T.height();
		1 == N.isTransActive && s > O.maxColHeight ? setTimeout(function() {
			T.height(O.maxColHeight)
		}, 700) : T.height(O.maxColHeight)
	}
	function g(e) {
		var t = e.index(),
			i = C.getPrevRowSameColIndex(t, O.numCols);
		if (0 > i) return !0;
		var n = j.getItem(i);
		return n.ordered_placed === !0 ? !0 : !1
	}
	function c(e, t) {
		if (t !== !0) {
			var i = g(e);
		...
		var n = e.index(),
			r = C.getColByIndex(O.numCols, n);
		d(e, !0, !0, r);
		var o = j.getItem(n);
		o.ordered_placed = !0, e.fadeTo(0, 1), A.triggerSizeChangeEvent(e);
		var a = j.getNumItems(),
			s = C.getNextRowSameColIndex(n, O.numCols);
		if (s >= a) return !1;
		var l = M.getThumbByIndex(s),
			u = j.getItem(s);
		M.isThumbLoaded(l) && !u.ordered_placed && c(l, !0)
	}
	function h(e, t) {
		if (1 == t) return !1;
		e = jQuery(e);
		var i = jQuery(e).parent();
		M.triggerImageLoadedEvent(i, e), 1 == z.tiles_keep_order ? c(i) : (d(i, !0, !0), i.fadeTo(0, 1), A.triggerSizeChangeEvent(i))
	}
	function p() {
		var e = M.getThumbs();
		l();
		var t = Math.abs(O.galleryWidth - O.totalWidth);
		if (1 == z.tiles_set_initial_height && 0 == C.isScrollbarExists() && 25 > t) {
			var i = (e.length, Math.ceil(e.length / O.numCols)),
				r = i * z.tiles_col_width * .75;
			T.height(r), l()
		}
		e.css("width", O.colWidth + "px"), e.fadeTo(0, 0);
		var o = O.numCols,
			a = O.galleryWidth,
			s = jQuery(T).find("img.ug-thumb-image"),
			u = !1;
		C.checkImagesLoaded(s, function() {
			l(), (o != O.numCols || a != O.galleryWidth) && _(!1), n()
		}, function(e, t) {
			0 == u && x.trigger(P.events.TILES_FIRST_PLACED), u = !0, h(e, t)
		})
	}
	function f() {
		var e = r(),
			t = M.getThumbs(),
			i = z.tiles_justified_row_height,
			n = [],
			o = 0,
			a = z.tiles_justified_space_between,
			s = t.length;
		jQuery.each(t, function(e, t) {
			t = jQuery(t);
			var r = (A.getTileImage(t), M.getItemByThumb(t)),
				a = r.thumbWidth,
				s = r.thumbHeight;
		...
		jQuery.each(i.arrRows, function(t, n) {
			...
			jQuery.each(n, function(t, n) {
				var u = jQuery(n),
					d = o,
					_ = r[t];
				A.resizeTile(u, _, d), C.placeElement(u, a, s), a += _, a > l && (l = a), a += i.gap, 1 == e && jQuery(n).show()
			}), s += o + i.gap
		}), a()
	}
	function v() {
		var e = jQuery(E).find("img.ug-thumb-image"),
			t = M.getThumbs();
		t.fadeTo(0, 0), C.checkImagesLoaded(e, function() {
			setTimeout(function() {
				m(!0), t.fadeTo(0, 1), x.trigger(P.events.TILES_FIRST_PLACED), n()
			})
		}, function(e) {
			e = jQuery(e);
			var t = jQuery(e).parent();
			M.triggerImageLoadedEvent(t, e)
		})
	}
	function b() {
		switch (E.children(".ug-tile").show(), A.run(), z.tiles_type) {
		default:
		case "columns":
			p();
			break;
		...
		1 == N.isFirstTimeRun && w(), N.isFirstTimeRun = !1
	}
	function y() {
		if (1 == N.isFirstTimeRun) return !0;
		switch (z.tiles_type) {
		case "columns":
			_(!1);
			break;
	...
	function w() {
		I.on(j.events.SIZE_CHANGE, y), A.initEvents()
	}
	var I, E, T, S, P = this,
		x = jQuery(this),
	...
	this.destroy = function() {
		I.off(j.events.SIZE_CHANGE), A.destroy()
	}, this.init = function(t, i) {
		e(t, i)
	}, this.setHtml = function(e) {
		i(e)
...
function UGTouchSliderControl() {
	...
	function l(e, t) {
		b.touch_active = !1, a(t)  //控制触摸开启模式 sunyang
	}
	function u(e) {
...
function UGTouchThumbsControl() {
	...
	function t() {
		E.thumb_touch_slowFactor = I.normalizeSetting(5e-5, .01, 1, 100, y.strip_thumb_touch_sensetivity, !0)
	}
	function i(e) {
...
function UGHtml5MediaAPI() {
	...
	function t(e, t, n, o, a) {
		...
		var g = "<video id='" + u + "' width='" + n + "' height='" + o + "' class='hover_play'  preload='none' " + d + " " + _ + ">"; // sunyang loop controls='controls'
		"" != t.mp4 && (g += "<source type='video/mp4' src='" + t.mp4 + "' />"), "" != t.webm && (g += "<source type='video/webm' src='" + t.webm + "' />"), "" != t.ogv && (g += "<source type='video/ogg' src='" + t.ogv + "' />"), g += "<object width='" + n + "' height='" + o + "' type='application/x-shockwave-flash' data='" + s + "'>", g += "<param name='movie' value='" + s + "' />", g += "<param name='flashvars' value='controls=false&file=" + t.mp4 + "' />", g += "</object>", g += "</video>",
		g+='<div class="control" style="padding-top:15px;padding-bottom:20px">';
		g+='<a href="#" class="btnPlay" style="margin-left:10px;"><i class="glyphicon glyphicon-pause"></i> 暂停</a>';
		g+='<a href="#" class="btnFullscreen" style="float:right;margin-right:10px;"><i class="glyphicon glyphicon-fullscreen"></i></a>';
		g+='<div class="progressTime"><span class="current_modes"></span> / <span class="duration_modes"></span></div>';
		g+='<div class="progress pro-sunyang" style="border:1px solid #337AB7;border-radius:0px;height:7px;width:100%;margin-top:5px;background-color:#d4d4d4;"><div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuemin="0" aria-valuemax="100" style="width:0%"></div></div>';
		g+='</div>', 
		jQuery("#" + e).html(g), 
		//sunyang
		play_modes = $('#gallery_videoplayer_html5_video').get(0);
		
		/**
		 * 
		 * @author:      Yang.Sun@dentsu.com.cn
		 * @dateTime:    2017-10-27 16:54:54
		 * @description: 播放器控制面板 全屏按钮
		 */
		$('.btnFullscreen').on('click',function(){
			var outBtn = $('.btnFullscreen').hasClass('outFullscreen');
			var element = $('.ug-videoplayer-html5').get(0);
			//console.log(outBtn);
			if(outBtn == false){
				requestFullScreen(element);
				$(this).addClass('outFullscreen');
			}else{
				exitFull();
				$(this).removeClass('outFullscreen');
			}
		})
		//回车键执行
		...
		//    if(event.keyCode == 27){
		//    		$('.btnFullscreen').removeClass('outFullscreen').text('全屏');
		//    }
		// });
		/**
		 * 
		 * @author:      Yang.Sun@dentsu.com.cn
		 * @dateTime:    2017-10-27 16:52:57
		 * @description: 封装全屏功能方法，兼容不同浏览器
		 */
		 ...
		 * 
		 * @author:      Yang.Sun@dentsu.com.cn
		 * @dateTime:    2017-10-27 17:05:44
		 * @description: 封装退出全屏功能方法，兼容不同浏览器
		 */
		function exitFull() {
		 // 判断各种浏览器，找到正确的方法
		 ...
		 * 
		 * @author:      Yang.Sun@dentsu.com.cn
		 * @dateTime:    2017-10-27 16:52:32
		 * @description: 播放、暂时
		 */
		$('.btnPlay,.hover_play').on('click',function(){
			if(play_modes.paused == false){
				play_modes.pause();
				$('.btnPlay').empty().append('<i class="glyphicon glyphicon-play"></i> 播放');
				$('.progress-bar').removeClass('active');
			}else{
				play_modes.play();
				$('.btnPlay').empty().append('<i class="glyphicon glyphicon-pause"></i> 暂停');
				$('.progress-bar').addClass('active');
			}
			return false;
		});
		//sunyang 总时长
		$('#gallery_videoplayer_html5_video').on('loadedmetadata',function(){
			$('.duration_modes').text(formatSeconds(play_modes.duration));
		});
		//sunyang 播放时间
		$('#gallery_videoplayer_html5_video').on('timeupdate',function(){
			var status_play = play_modes.currentTime; //当前播放时间;
			var sum_play = play_modes.duration; //总时长;
			$('.current_modes').text(formatSeconds(status_play));
			var percentage = 100*status_play/sum_play;
			$('.progress-bar').css('width',percentage+'%').html(parseInt(percentage)+'%');
			if(play_modes.ended){  //判断是否结束 非循环播放 sunyang
				play_modes.currentTime = 0;
				play_modes.pause();
				$('.btnPlay').empty().append('<i class="glyphicon glyphicon-play"></i> 重复播放');
			}
			//console.log(play_modes.buffered.end(0));  //区域加载
		});
		//sunyang 进度条控制
		$('.pro-sunyang').mousedown(function(e){
			e = e || window.event;
			updatebar(e.pageX);
		})
		var updatebar = function(x) {
			var maxduration = play_modes.duration; //Video 
			var positions = x - $('.pro-sunyang').offset().left; //Click pos

			var percentage = 100 * positions / $('.pro-sunyang').width();
			...
			play_modes.currentTime = maxduration * percentage / 100;
		};
	...
	function formatSeconds(value) {
	    ...
	    if(theTime > 60) {
	    	...
	    	return '00:'+zero(theTime);
	    }
	        var result = zero(theTime);
	        if(theTime1 > 0) {
	        result = ""+zero(theTime1)+":"+result;
	        }
	        // if(theTime2 > 0) {
...
function UGVideoPlayer() {
	...
	this.init = function(e, t, i) {
		...
		I = jQuery.extend(I, e), f.setOptions(I), t && 1 == t && (E.standAloneMode = !0)
	}, this.setHtml = function(e) {
		E.youtubeInnerID = o + "_youtube_inner", E.vimeoPlayerID = o + "_videoplayer_vimeo", E.html5PlayerID = o + "_videoplayer_html5", E.wistiaPlayerID = o + "_videoplayer_wistia", E.soundCloudPlayerID = o + "_videoplayer_soundcloud";
		var t = "<div class='ug-videoplayer' style='display:none'>";
		t += "<div class='ug-videoplayer-wrapper ug-videoplayer-youtube' style='display:none'><div id='" + E.youtubeInnerID + "'></div></div>", t += "<div id='" + E.vimeoPlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-vimeo' style='display:none'></div>", t += "<div id='" + E.html5PlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-html5'></div>", t += "<div id='" + E.soundCloudPlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-soundcloud'></div>", t += "<div id='" + E.wistiaPlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-wistia'></div>", 0 == E.standAloneMode && 1 == I.video_enable_closebutton && (t += "<div class='ug-videoplayer-button-close hide'></div>"), t += "</div>", e.append(t), a = e.children(".ug-videoplayer"), s = a.children(".ug-videoplayer-youtube"), l = a.children(".ug-videoplayer-vimeo"), u = a.children(".ug-videoplayer-html5"), _ = a.children(".ug-videoplayer-soundcloud"), g = a.children(".ug-videoplayer-wistia"), 0 == E.standAloneMode && 1 == I.video_enable_closebutton && (d = a.children(".ug-videoplayer-button-close"))
	}, this.destroy = function() {
		d && (d.off("click"), d.off("touchend")), jQuery(f).off(f.events.START_PLAYING), jQuery(f).off(f.events.STOP_PLAYING), jQuery(m).off(m.events.START_PLAYING), jQuery(m).off(m.events.STOP_PLAYING), jQuery(v).off(v.events.START_PLAYING), jQuery(v).off(v.events.STOP_PLAYING), jQuery(b).off(b.events.START_PLAYING, t), jQuery(b).off(b.events.STOP_PLAYING, i), jQuery(y).off(y.events.START_PLAYING, t), jQuery(y).off(y.events.STOP_PLAYING, i), w = null
	}, this.initEvents = function() {
		n()
	}, this.setSize = function(e, t) {
		...
		return 0 == c.isVisible() ? !0 : (r(), w = null, a.hide(), void h.trigger(c.events.HIDE))
		...
		r("youtube"), s.show();
		var i = s.children("#" + E.youtubeInnerID);
		0 == i.length && s.append("<div id='" + E.youtubeInnerID + "'></div>"), 1 == f.isPlayerReady() && 1 == E.standAloneMode ? f.changeVideo(e, t) : f.putVideo(E.youtubeInnerID, e, "100%", "100%", t), w = "youtube"
	}, this.playVimeo = function(e, t) {
		if ("undefined" == typeof t) var t = !0;
		r("vimeo"), l.show(), m.isPlayerReady() && 1 == E.standAloneMode ? m.changeVideo(e, t) : m.putVideo(E.vimeoPlayerID, e, "100%", "100%", t), w = "vimeo"
		...
		v.putVideo(E.html5PlayerID, a, "100%", "100%", o), w = "html5"
	}, this.playSoundCloud = function(e, t) {
		if ("undefined" == typeof t) var t = !0;
		r("soundcloud"), _.show(), b.putSound(E.soundCloudPlayerID, e, "100%", "100%", t), w = "soundcloud"
	}, this.playWistia = function(e, t) {
		if ("undefined" == typeof t) var t = !0;
		r("wistia"), g.show(), y.putVideo(E.wistiaPlayerID, e, "100%", "100%", t), w = "wistia"
	}
}
function UGZoomSliderControl() {
	function e(e, t) {
		E = e, I = jQuery(E), g_objects = e.getObjects(), y = g_objects.g_objSlider, w = g_objects.g_objInner, S = jQuery.extend(S, t), b()
	}
	function t() {
	...
	function n(e, i) {
		...
		1 == a && (I.trigger(E.events.ZOOMING), I.trigger(E.events.ZOOM_CHANGE), I.trigger(E.events.ZOOM_END))
	}
	function r(e, t, i) {
	...
	function d(e) {
		...
		0 == t && (P.imageOrientPoint = T.getElementCenterPoint(P.objImage)), I.trigger(E.events.ZOOM_START)
	}
	function _(e) {
		if (0 == P.isZoomActive) return !1;
		var t = T.getArrTouches(e);
		2 != t.length && (P.isZoomActive = !1, I.trigger(E.events.ZOOM_END))
	}
	function g(e) {
	...
	function c(e) {
		...
		T.setElementSizeAndPosition(P.objImage, _, g, o, a), I.trigger(E.events.ZOOMING), I.trigger(E.events.ZOOM_CHANGE)
	}
	function h() {
		if (void 0 == P.objImage || 0 == P.objImage.length) return !0;
	...
	function f(e) {
		...
		if (1 == P.isZoomActive ? _(e) : g(e), 1 == P.isZoomActive) 0 == P.isPanActive;
		else {
	...
	function v(e, t) {
		...
		e.preventDefault();
		var i = t > 0,
			r = T.getMousePosition(e),
			o = 1 == i ? "in" : "out";
		n(o, r)
	}
	function b() {
		y.on("mousewheel", v), y.bind("mousedown touchstart", p), jQuery("body").bind("mousemove touchmove", m), jQuery(window).add("body").bind("mouseup touchend", f), I.bind(E.events.BEFORE_RETURN, function() {
			h()
		}), I.bind(E.events.ITEM_CHANGED, function() {
			P.isZoomedOnce = !1
		}), I.bind(E.events.ZOOM_CHANGE, function() {
			P.isZoomedOnce = !0
		})
	}
	var y, w, I, E = new UGSlider,
		T = new UGFunctions,
		S = {
