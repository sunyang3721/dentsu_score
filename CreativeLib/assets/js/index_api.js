	...
	//日期检索
    $('#adddate dl').append(function(){
        var mydate = new Date();
        var html = '<dd data-id='+mydate.Format('YYYY-MM-DD')+'>今天</dd>';
            html += '<dd data-id='+mydate.Format('YYYY-MM-DD','30')+'>一月内</dd>';
            html += '<dd data-id='+mydate.Format('YYYY-MM-DD','90')+'>三月内</dd>';
            html += '<dd data-id='+mydate.Format('YYYY-MM-DD','183')+'>半年内</dd>';
            html += '<dd data-id='+mydate.Format('YYYY-MM-DD','365')+'>一年内</dd>';
        return html;
    });
	//检索hover 封装
	function select(id){
