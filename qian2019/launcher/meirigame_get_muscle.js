...
function send_muscle(){
   ...
   success: function(data){
    ...
    str+="<div class='content1_b_1'>"; 
     var span = '';
        ...
        str+="<p class='mingc '>"+JS_MSG_21+span+"</p>";  
        }     
   ...
   $("#meirigame").html(str);
   $("#content_xinxi").html("<span class='left'>"+JS_MSG_24+"<span id='fri_num'>"+fri_num+"</span>"+JS_MSG_25+"</span><span class='right'><img src='/resources/images/meiribisai/friend.png' width='56' height='41' onclick='show_share()'> </span>");
...
function muscle_mail(){
 	showLoading();
	var fri_num = 0;
	var mess="<span class='left'>"+JS_MSG_26+"</span>";
   ...
   success: function(data){
    ...
    //str+="<p class='mingc'>火爆浪子</p>";                                                                                                                       
    str+="<p class='guangshu'>"+JS_MSG_27+data[i].muscle_time+JS_MSG_28+"</p>";                                                                                                           
    str+="</div>";                                                                     
    str+="<p class='clear'></p>";                                                                                                            
    str+="</div>";                                                                                                          
    str+="<div class='content1_c'>";                                                                                                           
   ...
   $("#meirigame").html(str);
   $("#content_xinxi").html("<span class='left'>"+JS_MSG_24+"<span id='tili_num'>"+fri_num+"</span>"+JS_MSG_29+"</span>");
   $("#meiri_kaishi").html("<img src='/resources/images/meiribisai/BACK.png' width='606' height='70' onclick='fanhuibisai()'>");
   hideLoading();
    var yuanjiao_width= $(".meiripaix .paix .yuanjiao").innerWidth();
    $(".meiripaix .paix .yuanjiao").innerHeight(yuanjiao_width);
