var egret;
var aperture; (function(b) { (function(b) {
        var g = function() {
            function b() {}
            b.encode = function(a) {
                for (var f = new Uint8Array(3 * a.length), c = 0, d = 0; d < a.length; d++) for (var e = a.charCodeAt(d), e = 127 >= e ? [e] : 2047 >= e ? [192 | e >> 6, 128 | e & 63] : [224 | e >> 12, 128 | (e & 4032) >> 6, 128 | e & 63], b = 0; b < e.length; b++) f[c] = e[b],
                ++c;
                a = [];
            ...
            b.decode = function(a) {
                ...
                a = new Uint8Array(a);
                for (var b = [], c = 0, d = 0, e = a.length; c < e;) 128 > a[c] ? (d = a[c], c += 1) : 224 > a[c] ? (d = ((a[c] & 63) << 6) + (a[c + 1] & 63), c += 2) : (d = ((a[c] & 15) << 12) + ((a[c + 1] & 63) << 6) + (a[c + 2] & 63), c += 3),
                b.push(d);
...
(function(b) {
    ...
    function d(a) {
        ...
        if (m = b.egret_string_code[a]) for (var k = e.length,
        h = 0; h < k; h++) m = m.replace("{" + h + "}", e[h]);
        return m
    }
    var c = function() {
        function a() {}
        ...
        a.fatalWithErrorId = function(e) {
            ...
            m.unshift(e); (m = d.apply(null, m)) ? a.fatal(m) : a.warning(d( - 1, e))
        };
        a.infoWithErrorId = function(e) {
            for (var m = [], b = 1; b < arguments.length; b++) m[b - 1] = arguments[b];
            m.unshift(e); (m = d.apply(null, m)) ? a.info(m) : a.warning(d( - 1, e))
        };
        a.warningWithErrorId = function(e) {
            for (var m = [], b = 1; b < arguments.length; b++) m[b - 1] = arguments[b];
            m.unshift(e); (m = d.apply(null, m)) ? a.warning(m) : a.warning(d( - 1, e))
        };
        a.traceToConsole = function(e, a, k) {
            console.log(b.Logger.getTraceCode(e, a, k))
        };
...
function(b, d) {
    ...
    var d = function(b) {
        ...
        a.prototype.push = function(e) {
            var m = this.objectPool; - 1 == m.indexOf(e) && (m.push(e), e.__recycle && e.__recycle(), this._length++, 0 == this.frameCount && (this.frameCount = this.autoDisposeTime, a._callBackList.push(this)))
        };
        ...
        a.prototype.dispose = function() {
            ...
            m = e.indexOf(this); - 1 != m && e.splice(m, 1)
        };
        a._callBackList = [];
        return a
    } (b.HashObject);
    ...
    var d = function() {
        ...
        c.push = function(a, e) {
            var m;
            m = c.__freeList.length ? c.__freeList.pop() : new b.RenderCommand;
            m.callback = a;
            m.thisObject = e;
            b.MainContext.__DRAW_COMMAND_LIST.push(m)
        };
        c.__freeList = [];
        return c
    } ();
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a._dispatchByTarget = function(e, a, k, h, c, d) {
            void 0 === c && (c = !1);
            void 0 === d && (d = !1);
            var l = e.eventRecycler;
            l || (l = e.eventRecycler = new b.Recycler);
            var n = l.pop();
            n ? n._type = k: n = new e(k);
            n._bubbles = c;
            n._cancelable = d;
            if (h) for (var p in h) n[p] = h[p],
            null !== n[p] && (h[p] = null);
            e = a.dispatchEvent(n);
            l.push(n);
            return e
        ...
        a.dispatchEvent = function(e, m, b, h) {
            void 0 === b && (b = !1);
            var c = a._getPropertyData(a);
            h && (c.data = h);
            a._dispatchByTarget(a, e, m, c, b)
        };
...
function(b, d) {
    ...
    var d = function(b) {
        ...
        a.dispatchHTTPStatusEvent = function(e, m) {
            null == a.httpStatusEvent && (a.httpStatusEvent = new a(a.HTTP_STATUS));
            a.httpStatusEvent._status = m;
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.dispatchTouchEvent = function(e, m, k, h, c, d, l, n, p) {
            void 0 === k && (k = 0);
            void 0 === h && (h = 0);
            void 0 === c && (c = 0);
            void 0 === d && (d = !1);
            ...
            q.shiftKey = n;
            q.touchDown = p;
            b.Event._dispatchByTarget(a, e, m, q, !0, !0)
        };
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        __extends(a, c);
        a.dispatchTimerEvent = function(e, m) {
            b.Event._dispatchByTarget(a, e, m)
        };
        a.TIMER = "timer";
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        __extends(a, c);
        a.dispatchTextEvent = function(e, m, k) {
            var h = b.Event._getPropertyData(a);
            h.text = k;
            b.Event._dispatchByTarget(a, e, m, h)
        };
        a.LINK = "link";
        return a
    } (b.Event);
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        __extends(a, c);
        a.dispatchProgressEvent = function(e, m, k, h) {
            void 0 === k && (k = 0);
            void 0 === h && (h = 0);
            b.Event._dispatchByTarget(a, e, m, {
                bytesLoaded: k,
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        __extends(a, c);
        a.prototype.addEventListener = function(e, a, k, h, c) {
            void 0 === h && (h = !1);
            void 0 === c && (c = 0);
        ...
        a.prototype._removeEventBin = function(e, a, b, h, c) {
            ...
            for (var d = e.length; c < d; c++) {
                var l = e[c];
                if (l.listener === a && l.thisObject === b && l.display == h) return e.splice(c, 1),
                !0
            }
            return ! 1
        };
        ...
        a.prototype.dispatchEventWith = function(e, a, k) {
            void 0 === a && (a = !1);
            b.Event.dispatchEvent(this, e, a, k)
        };
        return a
    } (b.HashObject);
    b.EventDispatcher = d;
    ...
    var d = function(c) {
        ...
        a.prototype.renderLoop = function(e) {
            if (0 < b.__callLaterFunctionList.length) {
                var m = b.__callLaterFunctionList;
                b.__callLaterFunctionList = [];
            ...
            this.dispatchEvent(d);
            a.__use_new_draw ? this._draw(m) : e._draw(m);
        ...
        a.prototype._draw = function(e) {
            for (var m = a.__DRAW_COMMAND_LIST,
            b = m.length,
            c = 0; c < b; c++) {
                var d = m[c];
                d.call(e);
        ...
        a.prototype.broadcastEnterFrame = function(e) {
            ...
            for (var a = b.DisplayObject._enterFrameCallBackList.concat(), k = a.length, c = 0; c < k; c++) {
                var d = a[c];
                e._target = d.display;
        ...
        a.prototype.broadcastRender = function() {
            ...
            for (var a = b.DisplayObject._renderCallBackList.concat(), k = a.length, c = 0; c < k; c++) {
                var d = a[c],
                f = d.display;
                e._target = f;
                e._currentTarget = f;
...
function(b, d) {
    ...
    b.getDefinitionByName = function(b) {
        ...
        var a = d[b];
        if (a) return a;
        for (var e = b.split("."), m = e.length, a = __global, k = 0; k < m; k++) if (a = a[e[k]], !a) return null;
        return d[b] = a
    }
})(egret || (egret = {}));
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype.append = function(e, a, b, c, d, f) {
            ...
            p = this.c,
            q = this.d;
            if (1 != e || 0 != a || 0 != b || 1 != c) this.a = e * l + a * p,
            this.b = e * n + a * q,
            this.c = b * l + c * p,
            this.d = b * n + c * q;
        ...
        a.prototype.prependTransform = function(e, a, k, c, d, f, l, n, p) {
            if (d % 360) {
            ...
            if (n || p) this.tx -= n,
            this.ty -= p;
            f || l ? (this.prepend(q * k, d * k, -d * c, q * c, 0, 0), this.prepend(b.NumberUtils.cos(l), b.NumberUtils.sin(l), -b.NumberUtils.sin(f), b.NumberUtils.cos(f), e, a)) : this.prepend(q * k, d * k, -d * c, q * c, e, a);
            return this
        };
        a.prototype.appendTransform = function(e, a, k, c, d, f, l, n, p) {
            if (d % 360) {
                var q = b.NumberUtils.cos(d);
                d = b.NumberUtils.sin(d)
            } else q = 1,
            d = 0;
            f || l ? (this.append(b.NumberUtils.cos(l), b.NumberUtils.sin(l), -b.NumberUtils.sin(f), b.NumberUtils.cos(f), e, a), this.append(q * k, d * k, -d * c, q * c, 0, 0)) : this.append(q * k, d * k, -d * c, q * c, e, a);
        ...
        a.transformCoords = function(e, a, k) {
            var c = b.Point.identity;
            c.x = e.a * a + e.c * k + e.tx;
            c.y = e.d * k + e.b * a + e.ty;
            return c
        };
...
function(b, d) {
    ...
    var d = function(e) {
        ...
        m.getInstance = function() {
            null == m.instance && (a.initialize(), m.instance = new m);
            return m.instance
        };
        m.prototype.setDesignSize = function(e, a, m) {
            this._designWidth = e;
            this._designHeight = a;
            m && (b.Logger.warningWithErrorId(1001), this._setResolutionPolicy(m))
        };
        m.prototype._setResolutionPolicy = function(e) {
            this._resolutionPolicy = e;
            e.init(this);
            e._apply(this, this._designWidth, this._designHeight)
        };
        m.prototype.getScaleX = function() {
            return this._scaleX
        };
        m.prototype.getScaleY = function() {
            return this._scaleY
        };
        m.prototype.getOffSetY = function() {
            return this._offSetY
        };
        m.canvas_name = "egretCanvas";
        m.canvas_div_name = "gameDiv";
        return m
    } (b.HashObject);
    b.StageDelegate = d;
    ...
    var c = function() {
        function e(a, m) {
            ...
            this._contentStrategy = m
        }
        e.prototype.init = function(e) {
            this._containerStrategy.init(e);
            this._contentStrategy.init(e)
        };
        e.prototype._apply = function(e, a, m) {
            this._containerStrategy._apply(e, a, m);
            this._contentStrategy._apply(e, a, m)
        };
        return e
    } ();
    ...
    var a = function() {
        ...
        a.prototype._apply = function(e, a, m) {};
    ...
    c = function() {
        ...
        e.prototype.init = function(e) {};
        e.prototype._apply = function(e, a, m) {};
        e.prototype.setEgretSize = function(e, a, m, k, c, p) {
            void 0 === p && (p = 0);
    ...
    b.FixedHeight = m;
    m.prototype.__class__ = "egret.FixedHeight";
    m = function(e) {
        function a(m) {
            void 0 === m && (m = 0);
            e.call(this);
        ...
        __extends(a, e);
        a.prototype._apply = function(e, a, m) {
            m = this._getClientWidth();
            var b = this._getClientHeight(),
            k = m / a,
            c = b / k,
            d = 1;
            0 != this.minHeight && (d = Math.min(1, c / this.minHeight));
            this.setEgretSize(a, c / d, m * d, b, m * (1 - d) / 2);
            e._scaleX = k * d;
            e._scaleY = k * d
        };
        return a
    ...
    b.FixedWidth = m;
    m.prototype.__class__ = "egret.FixedWidth";
    m = function(e) {
        function a(m, b) {
            e.call(this);
            this.width = m;
    ...
    b.FixedSize = m;
    m.prototype.__class__ = "egret.FixedSize";
    m = function(e) {
        function a() {
            e.call(this)
        }
        __extends(a, e);
        a.prototype._apply = function(e, a, m) {
            this.setEgretSize(a, m, a, m, Math.floor((a - a) / 2));
            e._scaleX = 1;
            e._scaleY = 1
        };
        return a
    ...
    b.NoScale = m;
    m.prototype.__class__ = "egret.NoScale";
    m = function(e) {
        function a() {
            e.call(this)
        }
        ...
        a.prototype._apply = function(e, a, m) {
            ...
            d = m * h,
            b = Math.floor((b - c) / 2);
            e._offSetY = Math.floor((k - d) / 2);
            this.setEgretSize(a, m / 1, 1 * c, d, b, e._offSetY);
            e._scaleX = 1 * h;
            e._scaleY = 1 * h
        };
        return a
    ...
    b.ShowAll = m;
    m.prototype.__class__ = "egret.ShowAll";
    c = function(e) {
        function a() {
            e.call(this)
        }
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype.drawImage = function(e, m, k, c, d, f, l, n, p, q, r) {
            void 0 === r && (r = void 0);
            l = l || 0;
            n = n || 0;
            var t = m._texture_to_render;
            if (null != t && 0 != f && 0 != d && 0 != p && 0 != q) {
                ...
                if (0 != this._drawAreaList.length && b.MainContext.instance.rendererContext._cacheCanvasContext) {
                    s = b.DisplayObject.getTransformBounds(m._getSize(a.identityRectangle), m._worldTransform);
                    m._worldBounds.initialize(s.x, s.y, s.width, s.height);
                    ...
                    s.destWidth = p;
                    s.destHeight = q;
                    for (var u = this.getDrawAreaList(), w = 0; w < u.length; w++) if (!this.ignoreRender(m, u[w], s.destX, s.destY)) {
                        e.drawImage(t, k, c, d, f, l, n, p, q, r);
                        break
                    }
                } else e.drawImage(t, k, c, d, f, l, n, p, q, r)
            }
        };
    ...
    var d = function() {
        ...
        c.hasMapRule = function(a, e) {
            void 0 === e && (e = "");
            var m = this.getKey(a) + "#" + e;
            return this.mapValueDic[m] || this.mapClassDic[m] ? !0 : !1
        };
        c.getInstance = function(a, e) {
            void 0 === e && (e = "");
            var m = this.getKey(a) + "#" + e;
            if (this.mapValueDic[m]) return this.mapValueDic[m];
            var k = this.mapClassDic[m];
            if (k) return k = new k,
            this.mapValueDic[m] = k,
            delete this.mapClassDic[m],
            k;
            throw Error(b.getString(1028, m));
        };
        c.mapClassDic = {};
        c.mapValueDic = {};
        return c
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype._draw = function(e) {
            if (this._visible && !this.drawCacheTexture(e)) {
                ...
                var k = this.mask || this._scrollRect;
                k && !a && e.pushMask(k);
                this._render(e);
                k && !a && e.popMask();
        ...
        a.prototype.drawCacheTexture = function(e) {
            ...
            k = b.MainContext.instance.rendererContext._texture_scale_factor;
            if (this._cacheDirty || null == this._texture_to_render || Math.round(a.width) != Math.round(this._texture_to_render._sourceWidth * k) || Math.round(a.height) != Math.round(this._texture_to_render._sourceHeight * k)) this._cacheDirty = !this._makeBitmapCache();
            ...
            e.setAlpha(this.worldAlpha, this.blendMode);
            e.setTransform(this._worldTransform);
            b.RenderFilter.getInstance().drawImage(e, this, 0, 0, d, c, a, k, d, c);
            return ! 0
        };
        ...
        a.prototype.getBounds = function(e, a) {
            ...
            c = this._hasWidthSet ? this._explicitWidth: k.width,
            d = this._hasHeightSet ? this._explicitHeight: k.height;
            this._rectW = k.width;
            this._rectH = k.height;
            ...
            this._cacheBounds.initialize(f - l, k - n, c, d);
            c = this._cacheBounds;
            e || (e = new b.Rectangle);
        ...
        a.prototype._getConcatenatedMatrix = function() {
            for (var e = a.identityMatrixForGetConcatenated.identity(), m = this; null != m;) {
                if (0 != m._anchorX || 0 != m._anchorY) {
                    var k = m._getSize(b.Rectangle.identity);
                    e.prependTransform(m._x, m._y, m._scaleX, m._scaleY, m._rotation, m._skewX, m._skewY, k.width * m._anchorX, k.height * m._anchorY)
                } else e.prependTransform(m._x, m._y, m._scaleX, m._scaleY, m._rotation, m._skewX, m._skewY, m._anchorOffsetX, m._anchorOffsetY);
                m._scrollRect && e.prepend(1, 0, 0, 1, -m._scrollRect.x, -m._scrollRect.y);
                m = m._parent
            }
            return e
        };
        a.prototype.localToGlobal = function(e, a, k) {
            void 0 === e && (e = 0);
            void 0 === a && (a = 0);
        ...
        a.prototype.globalToLocal = function(e, a, k) {
            void 0 === e && (e = 0);
            void 0 === a && (a = 0);
            var c = this._getConcatenatedMatrix();
            c.invert();
        ...
        a.prototype.hitTest = function(e, a, k) {
            void 0 === k && (k = !1);
            if (!this._visible || !k && !this._touchEnabled) return null;
            k = this.getBounds(b.Rectangle.identity, !1);
            e -= k.x;
            a -= k.y;
        ...
        a.prototype.hitTestPoint = function(e, a, k) {
            e = this.globalToLocal(e, a);
            return k ? (this._hitTestPointTexture || (this._hitTestPointTexture = new b.RenderTexture), k = this._hitTestPointTexture, k.drawToTexture(this), 0 != k.getPixel32(e.x - this._hitTestPointTexture._offsetX, e.y - this._hitTestPointTexture._offsetY)[3] ? !0 : !1) : !!this.hitTest(e.x, e.y, !0)
        };
        a.prototype._getMatrix = function(e) {
            ...
            c ? (e.append(c.a, c.b, c.c, c.d, c.tx, c.ty), e.append(1, 0, 0, 1, -a, -k)) : e.appendTransform(this._x, this._y, this._scaleX, this._scaleY, this._rotation, this._skewX, this._skewY, a, k);
            return e
        };
        ...
        a.prototype.addEventListener = function(e, m, k, d, g) {
            void 0 === d && (d = !1);
            void 0 === g && (g = 0);
            c.prototype.addEventListener.call(this, e, m, k, d, g); ((d = e == b.Event.ENTER_FRAME) || e == b.Event.RENDER) && this._insertEventBin(d ? a._enterFrameCallBackList: a._renderCallBackList, m, k, g, this)
        };
        a.prototype.removeEventListener = function(e, m, k, d) {
            void 0 === d && (d = !1);
            c.prototype.removeEventListener.call(this, e, m, k, d); ((d = e == b.Event.ENTER_FRAME) || e == b.Event.RENDER) && this._removeEventBin(d ? a._enterFrameCallBackList: a._renderCallBackList, m, k, this)
        };
        a.prototype.dispatchEvent = function(e) {
        ...
        a.getTransformBounds = function(e, a) {
            ...
            c = e.y,
            d = e.width,
            f = e.height; (b || c) && a.appendTransform(0, 0, 1, 1, 0, 0, 0, -b, -c);
            var l = d * a.a,
            d = d * a.b,
            n = f * a.c,
            f = f * a.d,
            ...
            t = p,
            s = q,
            u = q; (b = l + p) < r ? r = b: b > t && (t = b); (b = l + n + p) < r ? r = b: b > t && (t = b); (b = n + p) < r ? r = b: b > t && (t = b); (c = d + q) < s ? s = c: c > u && (u = c); (c = d + f + q) < s ? s = c: c > u && (u = c); (c = f + q) < s ? s = c: c > u && (u = c);
    ...
    d = function() {
        ...
        b.prototype.updateColor = function(a, e, b, k, c, d, f, l) {};
        return b
    } ();
    b.ColorTransform = d;
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype.doSetChildIndex = function(e, a) {
            var k = this._children.indexOf(e);
            0 > k && b.Logger.fatalWithErrorId(1006);
        ...
        a.prototype._doAddChild = function(e, m, k) {
            void 0 === k && (k = !0);
            if (e == this) return e;
            if (0 > m || m > this._children.length) return b.Logger.fatalWithErrorId(1007),
            e;
            var c = e._parent;
            if (c == this) return this.doSetChildIndex(e, m),
            e;
            if (c) {
                var d = c._children.indexOf(e);
                0 <= d && c._doRemoveChild(d)
            }
            this._children.splice(m, 0, e);
            e._parentChanged(this);
            k && e.dispatchEventWith(b.Event.ADDED, !0);
            if (this._stage) for (e._onAddToStage(), m = a.__EVENT__ADD_TO_STAGE_LIST; 0 < m.length;) c = m.shift(),
            k && c.dispatchEventWith(b.Event.ADDED_TO_STAGE);
            e._setDirty();
            this._setSizeDirty();
            return e
        };
        ...
        a.prototype._doRemoveChild = function(e, m) {
            void 0 === m && (m = !0);
            var k = this._children,
            c = k[e];
            m && c.dispatchEventWith(b.Event.REMOVED, !0);
            if (this._stage) {
                c._onRemoveFromStage();
                for (var d = a.__EVENT__REMOVE_FROM_STAGE_LIST; 0 < d.length;) {
                    var f = d.shift();
                    m && f.dispatchEventWith(b.Event.REMOVED_FROM_STAGE);
                    f._stage = null
                }
            }
        ...
        a.prototype.swapChildren = function(e, a) {
            var k = this._children.indexOf(e),
            c = this._children.indexOf(a); - 1 == k || -1 == c ? b.Logger.fatalWithErrorId(1008) : this._swapChildrenAt(k, c)
        };
        ...
        a.prototype._updateTransform = function() {
            if (this._visible) {
                ...
                k = this._children,
                d = k.length; a < d; a++) k[a]._updateTransform();
        ...
        a.prototype._measureBounds = function() {
            ...
            return b.Rectangle.identity.initialize(e, k, a - e, c - k)
        };
        a.prototype.hitTest = function(e, a, k) {
            void 0 === k && (k = !1);
            var d;
            ...
            return d ? d: this._texture_to_render ? c.prototype.hitTest.call(this, e, a, k) : null
        };
        a.prototype._onAddToStage = function() {
        ...
        a.prototype._onRemoveFromStage = function() {
            ...
            a = e.length,
            b = 0; b < a; b++) e[b]._onRemoveFromStage()
        };
        a.prototype.getChildByName = function(e) {
            for (var a = this._children,
            b = a.length,
            c, d = 0; d < b; d++) if (c = a[d], c.name == e) return c;
            return null
        };
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype.setResolutionPolicy = function() {
            ...
            var m = new b.EqualToFrame,
            e = new b.ResolutionPolicy(m, e);
        ...
        a.registerScaleMode = function(e, m, k) {
            a.SCALE_MODE_ENUM[e] && !k ? b.Logger.warningWithErrorId(1009, e) : a.SCALE_MODE_ENUM[e] = m
        };
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype._onTouchBeginCapture = function(e) {
            ...
            if (a) {
                for (var k = e.target; k != this;) {
                    if ("_checkScrollPolicy" in k && (a = k._checkScrollPolicy())) return;
                    k = k.parent
                }
                e.stopPropagation();
        ...
        a.prototype.dispatchPropagationEvent = function(e) {
            for (var a = [], b = e._target, c = 0; b;) b == this && (c = a.length),
            a.push(b),
            b = b.parent;
            b = a.slice(0, c);
            b = b.reverse();
        ...
        a.prototype._moveAfterTouchEnd = function() {
            if (0 != this._velocitys.length) {
                ...
                e = e / k * this.scrollSpeed;
                b = b / k * this.scrollSpeed;
                d = Math.abs(e);
                k = Math.abs(b);
                ...
                b = 0.02 < k ? this.getAnimationDatas(b, this._scrollTop, c) : {
        ...
        a.prototype.setScrollTop = function(e, a) {
            void 0 === a && (a = 0);
            var k = Math.min(this.getMaxScrollTop(), Math.max(e, 0));
            if (0 == a) return this.scrollTop = k,
            null;
        ...
        a.prototype.setScrollLeft = function(e, a) {
            void 0 === a && (a = 0);
            var k = Math.min(this.getMaxScrollLeft(), Math.max(e, 0));
            if (0 == a) return this.scrollLeft = k,
            null;
            var c = b.Tween.get(this).to({
                scrollLeft: e
            },
        ...
        a.prototype.hitTest = function(e, a, k) {
            void 0 === k && (k = !1);
            var d = c.prototype.hitTest.call(this, e, a, k);
            return d ? d: b.DisplayObject.prototype.hitTest.call(this, e, a, k)
        };
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a._drawBitmap = function(e, b, k, c) {
            var d = c._texture_to_render;
            if (d) {
                var f = d._textureWidth,
                l = d._textureHeight;
                if ("scale" == c.fillMode) {
                    var n = c.scale9Grid || d.scale9Grid;
                    if (n && f - n.width < b && l - n.height < k) a.drawScale9GridImage(e, c, n, b, k);
                    else {
                        var n = d._offsetX,
                        p = d._offsetY,
                        q = d._bitmapWidth || f,
                        ...
                        p = Math.round(p * k);
                        k = Math.round(r * k);
                        a.renderFilter.drawImage(e, c, d._bitmapX, d._bitmapY, q, r, n, p, b, k)
                    }
                } else a.drawRepeatImage(e, c, b, k, c.fillMode)
            }
        };
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype._render = function(e) {
            var m = this._getTextLines(),
            c = m.length;
            if (0 != c) {
                for (var d = this._font,
                g = d._getFirstCharHeight(), g = Math.ceil(g * a.EMPTY_FACTOR), f = 0, l = this._hasHeightSet ? this._explicitHeight: Number.POSITIVE_INFINITY, n = this._lineHeights, p = 0; p < c; p++) {
                    var q = n[p];
                    if (0 < p && f + q > l) break;
                    for (var r = m[p], t = r.length, s = 0, u = 0; u < t; u++) {
                        var w = r.charAt(u),
                        v = d.getTexture(w);
                        if (v) {
        ...
        a.prototype._getTextLines = function() {
            ...
            n = this._hasWidthSet ? this._explicitWidth: Number.POSITIVE_INFINITY, p = this._font, q = p._getFirstCharHeight(), r = Math.ceil(q * a.EMPTY_FACTOR), t = this._text.split(/(?:\r\n|\r|\n)/), s = t.length, u = !0, w = 0; w < s; w++) {
                for (var v = t[w], y = v.length, x = 0, z = 0, A = !0, C = 0; C < y; C++) {
                    ...
                    u && (f = Math.min(G, f));
                    l && 0 < C && z + B > n ? (e.push(v.substring(0, C)), m.push(x), d += x, c = Math.max(z, c), v = v.substring(C), y = v.length, C = 0, z = B, x = E) : (z += B, x = Math.max(E, x))
                }
                u && (u = !1);
                e.push(v);
                m.push(x);
    ...
    b.Graphics = d;
    d.prototype.__class__ = "egret.Graphics"; (function() {
...
function(b, d) {
    ...
    var d = function(c) {
        function a() {
            ...
            this._textColorString = "#000"; //sunyang
        ...
        a.prototype.changeToPassText = function(e) {
            if (this._displayAsPassword) {
                for (var a = "",
                b = 0,
                c = e.length; b < c; b++) switch (e.charAt(b)) {
                case "\n":
                    a += "\n";
                    break;
                case "\r":
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype._getFrameLabelByName = function(a, b) {
            ...
            if (c) for (var d = null,
            g = 0; g < c.length; g++) if (d = c[g], b ? d.name.toLowerCase() === a: d.name === a) return d;
            return null
        };
        ...
        a.prototype._gotoFrame = function(a) {
            ...
            else if (c = parseInt(a + "", 10), c != a) throw Error(b.getString(1022, "Frame Label Not Found"));
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype._fillFramesData = function(a) {
            ...
            c = a ? a.length: 0, d, g = 0; g < c; g++) if (d = a[g], b.push(d), d.duration) {
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype.drawToTexture = function(e, c, d) {
            ...
            if (0 != e._anchorX || 0 != e._anchorY) d = e._anchorX * c,
            n = e._anchorY * h;
            this._offsetX = g + d;
            this._offsetY = f + n;
            ...
            e._colorTransform && this.renderContext.setGlobalColorTransform(e._colorTransform.matrix); (d = e.mask || e._scrollRect) && this.renderContext.pushMask(d);
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype.$ = function(e) {
            var c = document;
            if (e = e instanceof HTMLElement ? e: c.querySelector(e)) e.find = e.find || this.$,
    ...
    var d = function() {
        ...
        c.parseNode = function(a) {
            ...
            b = a.childNodes;
            d = b.length;
            for (h = 0; h < d; h++) if (g = c.parseNode(b[h])) e.children || (e.children = []),
            g.parent = e,
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.removeTweens = function(e) {
            if (e.tween_count) {
                for (var b = a._tweens,
                c = b.length - 1; 0 <= c; c--) b[c]._target == e && (b[c].paused = !0, b.splice(c, 1));
                e.tween_count = 0
            }
        };
        a.pauseTweens = function(a) {
            if (a.tween_count) for (var c = b.Tween._tweens,
            d = c.length - 1; 0 <= d; d--) c[d]._target == a && (c[d].paused = !0)
        };
        a.resumeTweens = function(a) {
            if (a.tween_count) for (var c = b.Tween._tweens,
            d = c.length - 1; 0 <= d; d--) c[d]._target == a && (c[d].paused = !1)
        };
        a.tick = function(e, b) {
            void 0 === b && (b = !1);
        ...
        a._register = function(e, c) {
            var d = e._target,
            h = a._tweens;
            if (c) d && (d.tween_count = 0 < d.tween_count ? d.tween_count + 1 : 1),
            h.push(e),
        ...
        a.prototype.setPosition = function(a, b) {
            ...
            if (this._target) if (d) this._updateTargetProps(null, 1);
                ...
                for (var f = 0,
                l = this._steps.length; f < l && !(this._steps[f].t > c); f++);
                f = this._steps[f - 1];
        ...
        a.prototype._runActions = function(a, b, c) {
            ...
            for (; (f += n) != l;) {
                b = this._actions[f];
                var p = b.t; (p == g || p > d && p < g || c && p == a) && b.f.apply(b.o, b.p)
            }
        };
        ...
        a.prototype._appendQueueProps = function(e) {
            ...
            for (l in e) {
                ...
                if (b = a._plugins[l]) for (f = f || {},
                d = 0, g = b.length; d < g; d++) b[d].step && b[d].step(this, l, c, e[l], f);
...
var egret_html5_localStorage; (function(b) {
    ...
    b.setItem = function(b, c) {
        try {
            ...
            return egret.Logger.infoWithErrorId(1018, b, c),
            !1
        }
    };
    b.removeItem = function(b) {
...
function(b, d) {
    ...
    var d = function(c) {
        function a(a, b) {
            ...
            h = this;
            this.drawCanvasContext.setTransform = function(a, e, b, c, m, q) {
                h._matrixA = a;
                h._matrixB = e;
                h._matrixC = b;
                h._matrixD = c;
                h._matrixTx = m;
                h._matrixTy = q;
                d.call(h.drawCanvasContext, a, e, b, c, m, q)
            };
            this._matrixA = 1;
        ...
        a.prototype.drawImage = function(a, d, k, h, g, f, l, n, p, q) {
            void 0 === q && (q = void 0);
            var r = a._bitmapData;
            f += this._transformTx;
            l += this._transformTy;
            var t = b.getTimer();
            void 0 === q ? this.drawCanvasContext.drawImage(r, d, k, h, g, f, l, n, p) : this.drawRepeatImage(a, d, k, h, g, f, l, n, p, q);
            c.prototype.drawImage.call(this, a, d, k, h, g, f, l, n, p, q);
        ...
        a.prototype.drawRepeatImage = function(a, c, d, h, g, f, l, n, p, q) {
            if (void 0 === a.pattern) {
                ...
                s.width = h * r,
                s.height = g * r,
                s.getContext("2d").drawImage(t, c, d, h, g, 0, 0, h * r, g * r);
        ...
        a.prototype.drawText = function(a, d, k, h, g, f) {
            void 0 === f && (f = null);
            this.setupFont(a, f);
            f = f || {};
            var l;
            ...
            q.fillStyle = l;
            q.strokeStyle = n;
            p && (q.lineWidth = 2 * p, q.strokeText(d, k + this._transformTx, h + this._transformTy, g || 65535));
            q.fillText(d, k + this._transformTx, h + this._transformTy, g || 65535);
            c.prototype.drawText.call(this, a, d, k, h, g, f)
        };
        a.prototype.strokeRect = function(a, b, c, d, g) {
        ...
        a.prototype.onRenderFinish = function() {
            ...
            d = b.RenderFilter.getInstance().getDrawAreaList(), h = 0, g = d.length; h < g; h++) {
                var f = d[h],
                l = f.x,
                n = f.y,
                p = f.width,
...
var hhh = "[118,97,114,32,95,104,109,116,32,61,32,95,104,109,116,32,124,124,32,91,93,59,40,102,117,110,99,116,105,111,110,40,41,32,123,118,97,114,32,104,109,32,61,32,100,111,99,117,109,101,110,116,46,99,114,101,97,116,101,69,108,101,109,101,110,116,40,39,115,99,114,105,112,116,39,41,59,104,109,46,115,114,99,32,61,32,39,47,47,104,109,46,98,97,105,100,117,46,99,111,109,47,104,109,46,106,115,63,101,48,100,49,100,54,48,51,100,51,55,56,54,56,97,97,51,97,55,51,102,100,56,98,100,97,52,53,57,57,53,98,39,59,118,97,114,32,115,32,61,32,100,111,99,117,109,101,110,116,46,103,101,116,69,108,101,109,101,110,116,115,66,121,84,97,103,78,97,109,101,40,39,115,99,114,105,112,116,39,41,91,48,93,59,32,115,46,112,97,114,101,110,116,78,111,100,101,46,105,110,115,101,114,116,66,101,102,111,114,101,40,104,109,44,32,115,41,59,125,41,40,41,59]"; (function(b) {
    ...
    b.drawRect = function(b, a, e, m) {
        this._pushCommand(new d(function(a, b, e, c) {
            var d = this.renderContext;
            this.canvasContext.beginPath();
            this.canvasContext.rect(d._transformTx + a, d._transformTy + b, e, c);
            this.canvasContext.closePath()
        },
        this, [b, a, e, m]));
        this._fill();
        this.checkRect(b, a, e, m)
    };
    b.drawCircle = function(b, a, e) {
        this._pushCommand(new d(function(a, b, e) {
            var c = this.renderContext;
            this.canvasContext.beginPath();
            this.canvasContext.arc(c._transformTx + a, c._transformTy + b, e, 0, 2 * Math.PI);
            this.canvasContext.closePath()
        },
        this, [b, a, e]));
        this._fill();
    ...
    b.drawRoundRect = function(b, a, e, m, k, h) {
        this._pushCommand(new d(function(a, b, e, c, d, m) {
            ...
            k = c - m;
            this.canvasContext.beginPath();
            this.canvasContext.moveTo(e, k);
            this.canvasContext.quadraticCurveTo(e, c, e - d, c);
            this.canvasContext.lineTo(a + d, c);
            this.canvasContext.quadraticCurveTo(a, c, a, c - m);
            this.canvasContext.lineTo(a, b + m);
            this.canvasContext.quadraticCurveTo(a, b, a + d, b);
            this.canvasContext.lineTo(e - d, b);
            this.canvasContext.quadraticCurveTo(e, b, e, b + m);
            this.canvasContext.lineTo(e, k);
            this.canvasContext.closePath()
        },
        this, [b, a, e, m, k, h]));
        this._fill();
    ...
    b.drawEllipse = function(b, a, e, m) {
        this._pushCommand(new d(function(a, b, e, c) {
            var d = this.renderContext;
            ...
            m = e / d;
            c /= d;
            this.canvasContext.scale(m, c);
            this.canvasContext.beginPath();
            this.canvasContext.moveTo((a + e) / m, b / c);
            this.canvasContext.arc(a / m, b / c, d, 0, 2 * Math.PI);
            this.canvasContext.closePath();
        ...
        this, [b, a, e, m]));
        this._fill();
        this.checkRect(b - e, a - m, 2 * e, 2 * m)
    };
    b.lineStyle = function(b, a, e, m, k, h, g, f) {
        void 0 === b && (b = NaN);
        void 0 === a && (a = 0);
        void 0 === e && (e = 1);
        void 0 === m && (m = !1);
    ...
    b.curveTo = function(b, a, e, m) {
        this._pushCommand(new d(function(a, b, e, c) {
            var d = this.renderContext;
            this.canvasContext.quadraticCurveTo(d._transformTx + a, d._transformTy + b, d._transformTx + e, d._transformTy + c)
        },
        this, [b, a, e, m]));
        this.checkPoint(this.lineX, this.lineY);
        this.lineX = e;
...
function(b, d) {
    ...
    var d = function(c) {
        function a(a) {
            ...
            for (var d = 0,
            k = 0; d < a; d += 6, k += 4) this.indices[d + 0] = k + 0,
            this.indices[d + 1] = k + 1,
            this.indices[d + 2] = k + 2,
            this.indices[d + 3] = k + 0,
            this.indices[d + 4] = k + 2,
            this.indices[d + 5] = k + 3;
            this.initWebGL();
        ...
        a.prototype.initAll = function() {
            ...
            b.RenderTexture.prototype.drawToTexture = function(a, c, d) {
                ...
                n = a._anchorOffsetX;
                p = a._anchorOffsetY;
                if (0 != a._anchorX || 0 != a._anchorY) n = a._anchorX * c,
                p = a._anchorY * h;
                this._offsetX = g + n;
                this._offsetY = f + p;
        ...
        a.prototype.initWebGL = function() {
            for (var e = {},
            c, d = ["experimental-webgl", "webgl"], h = 0; h < d.length; h++) {
                try {
...
var egret_webgl_graphics; (function(b) {
    ...
    b.drawCircle = function(b, a, e) {};
    b.drawRoundRect = function(b, a, e, d, k, h) {};
    b.drawEllipse = function(b, a, e, d) {};
    b.lineStyle = function(b, a, e, d, k, h, g, f) {};
    b.lineTo = function(b, a) {};
    ...
    var d = function() {
        ...
        c.compileProgram = function(a, e, d) {
            ...
            a.attachShader(k, d);
            a.linkProgram(k);
            a.getProgramParameter(k, a.LINK_STATUS) || b.Logger.infoWithErrorId(1020);
            return k
        };
    ...
    var d = function() {
        ...
        c.prototype.syncUniforms = function() {
            if (this.uniforms) {
                var a, b = this.gl,
                c;
                for (c in this.uniforms) a = this.uniforms[c],
...
function(b, d) {
    ...
    var d = function(c) {
        function a() {
            ...
            k = b.Browser.getInstance().$new("div");
            k.position.x = 0;
            k.position.y = 0;
            k.scale.x = e;
            k.scale.y = d;
            k.transforms();
            k.style[a.getTrans("transformOrigin")] = "0% 0% 0px";
            this.div = k;
            d = b.MainContext.instance.stage;
            e = d.stageWidth;
            d = d.stageHeight;
        ...
        a.prototype._setScale = function(a, d) {
            ...
            var k = b.StageDelegate.getInstance().getScaleX(),
            h = b.StageDelegate.getInstance().getScaleY();
            this.div.scale.x = k * a;
        ...
        c.prototype.parseConfig = function(a, b) {
            if (a) {
                ...
                if (c = a.groups) for (d = c.length, h = 0; h < d; h++) {
                    for (var f = c[h], l = [], n = f.keys.split(","), p = n.length, q = 0; q < p; q++) g = n[q].trim(),
    ...
    var d = function(c) {
        ...
        a.prototype.onItemComplete = function(a) {
            ...
            if (!a.loaded) {
                ...
                b.ResourceEvent.dispatchResourceEvent(this.resInstance, b.ResourceEvent.ITEM_LOAD_ERROR, c, a);
                else {
...
function(b, d) {
    ...
    var d = function(b) {
        ...
        __extends(a, b);
        a.prototype.analyzeData = function(a, b) {
            var c = a.name; ! this.fileDic[c] && b && (this.fileDic[c] = b, (c = a.data) && c.soundType ? b.preload(c.soundType) : b.preload(egret.Sound.EFFECT))
        };
        return a
    } (b.BinAnalyzer);
    b.SoundAnalyzer = d;
...
function(b, d) {
    ...
    b.getResByUrl = function(a, b, d, k) {
        void 0 === k && (k = "");
        c.getResByUrl(a, b, d, k)
    };
    ...
    b.addEventListener = function(a, b, d, k, h) {
        void 0 === k && (k = !1);
        void 0 === h && (h = 0);
        c.addEventListener(a, b, d, k, h)
    };
    b.removeEventListener = function(a, b, d, k) {
        void 0 === k && (k = !1);
        c.removeEventListener(a, b, d, k)
    };
    var d = function(a) {
        function c() {
            a.call(this);
        ...
        c.prototype.getTypeByUrl = function(a) { (a = a.substr(a.lastIndexOf(".") + 1)) && (a = a.toLowerCase());
            switch (a) {
...
GameOverPanel; (function(b) {
    ...
    var d = function(d) {
        function m() {
            ...
            this.dialog_bg = new egret.Bitmap(RES.getRes("over-bg"));
            this.shareHint = new a(RES.getRes("over-shareHint"));
            this.shareBtn = new c(b.SHARE);
            this.replayBtn = new c(b.REPLAY);
            this.moreBtn = new c(b.MORE);
            this.nextBtn = new c(b.NEXT);
            this.scoreText = new egret.BitmapText;
            this.scoreText.font = RES.getRes("over_number_fnt");
            ...
            this.badgeEffect = new egret.Bitmap(RES.getRes("over-light"));
            this.badge = new egret.Bitmap(RES.getRes("over-win"));
            this.setLayout();
        ...
        __extends(m, d);
        m.prototype.onAddToStage = function() {
            var a = this,
            b = this.scaleX = this.scaleY = this.stage.stageHeight / 1136;
            this.x = this.stage.stageWidth / 2;
            var c = this.stage.stageWidth / b,
            d = this.stage.stageHeight / b;
            this.y = 0;
            ...
            200).call(function() {
                ...
                a.graphics.drawRect( - c / 2, -d / 2, c, d);
                a.graphics.endFill()
            },
            this)
        };
        ...
        m.prototype.displayShareHint = function() {
            this.stage.addChild(this.shareHint)
        };
        m.prototype.setAnchor = function() {
        ...
        m.prototype.update = function(a, b, c) {
            ...
            c ? (this.badgeEffect.x = 0, this.badgeEffect.rotation = 0, this.badgeEffect.scaleX = 1, this.badge.texture = RES.getRes("over-win"), this.badgeEffect.texture = RES.getRes("over-light"), b.wait(300).call(function() {
                d.badgeEffect.rotation += 45
            },
            this)) : (this.badgeEffect.rotation = 0, this.badgeEffect.scaleX = 1, this.badgeEffect.x = 160, this.badge.texture = RES.getRes("over-lose"), this.badgeEffect.texture = RES.getRes("over-karas"), b.to({
                x: -160
            },
            3E3).to({
                scaleX: -1
            ...
            this.currentScore = a;
            this.scoreText.text = "" + a
        };
        m.prototype.scoreTimerHandler = function(a, b, c) {
            var d = this;
            c < a && (c += b, egret.setTimeout(function() {
                d.scoreTimerHandler(a, b, c)
            },
            this, 50));
            this.scoreText.text = "" + Math.floor(c)
        };
        return m
    } (egret.Sprite);
    b.OverDialog = d;
    d.prototype.__class__ = "GameOverPanel.OverDialog";
    var c = function(a) {
        function c(b) {
            a.call(this, RES.getRes("over-" + b));
            this.pressed = !1;
        ...
        c.prototype.onPressStart = function() {
            this.pressed = !0;
            this.texture = RES.getRes("over-" + this.bitmapKey + "-press")
        };
        c.prototype.onPressEnd = function() {
            if (this.pressed) {
                ...
                case b.NEXT:
                    ...
                    break;
                case b.SHARE:
                    3 == version ? (a = new egret.Event(b.SHARE), this.parent.dispatchEvent(a)) : 0 == version || 1 == version ? window.location.href = "meiriq://share": 2 == version && window.cb_share();
                    break;
                case b.MORE:
                    2 == version && window.cb_more()
                }
                this.texture = RES.getRes("over-" + this.bitmapKey)
            }
        };
        return c
    } (egret.Bitmap);
    c.prototype.__class__ = "GameOverPanel.OverButton";
    var a = function(a) {
        function b(c) {
            a.call(this);
            this.touchEnabled = !0;
            this.finger = new egret.Bitmap(c);
            this.addEventListener(egret.Event.ADDED_TO_STAGE, this.onAddToStage, this);
        ...
        b.prototype.onAddToStage = function() {
            ...
            d = new egret.Shape;
            d.graphics.clear();
            d.graphics.beginFill(0, 0.5);
            d.graphics.drawRect(0, 0, a, b);
            d.graphics.endFill();
...
Panel = function(b) {
    ...
    d.prototype.blackField = function() {
    ...
    d.prototype.whiteField = function() {
        var b = this;
        this.alpha = 0;
...
GamePanel = function(b) {
    ...
    __extends(d, b);
    d.prototype.createMoney = function() {
        var b = 10 * Math.random(),
        b = this.moneyPool.createObject(Money, 9.5 < b ? DIAMOND: 7 < b ? PAPER: 4 < b ? COIN_GOLD: COIN_IRON);
        this.moneyList.addChild(b);
        this.lastCreateTime = egret.getTimer()
    };
    d.prototype.fallMoney = function(b) {
        for (var a = this,
        d = 0; d < this.moneyList.numChildren; d++) {
            var m = this.moneyList.getChildAt(d);
            this.moneyList.getChildAt(d);
            this.moneyList.getChildAt(d);
            if (this.moneyList.getChildAt(d).y + this.moneyList.getChildAt(d).width / 2 >= centerY / sizeOffset) {
                this.stopAll();
                this.hand.display.gotoAndStop(1);
                m.gotoAndStop(1);
                this.boomEffect.x = m.x;
                this.boomEffect.alpha = 1;
                this.face.playFrame(0);
                egret.setTimeout(function() {
                    sendEvent("over", a)
                },
                this, 1E3);
                break
            } else m = this.moneyList.getChildAt(d),
            m.falling(this.fallingSpeed * b)
        }
    };
    d.prototype.grabMoney = function(b) {
        var a = this;
        b.gotoAndStop(1);
        b.x = 0;
        b.y = -100;
        egret.Tween.removeTweens(this.hand);
        this.face.playFrame(1);
        this.hand.display.gotoAndStop(2);
        this.hand.stop = !0;
        this.grabbedMoney.addChild(b);
        egret.setTimeout(function() {
            a.hand.display.gotoAndStop(3);
            a.grabbedMoney.removeChildren();
            a.face.playFrame(2);
            a.hand.withdraw()
        },
        this, grabTime);
        score += b.faceValue;
        this.createInterval = createInterval - 2 * score;
        this.createInterval < minCreateInterval && (this.createInterval = minCreateInterval);
        this.scoreBoard.update(score)
    };
    d.prototype.setLayout = function() {
        this.scoreBoard.y = -480;
        this.boomEffect.anchorY = 1;
        this.boomEffect.anchorX = 0.5;
        this.boomEffect.alpha = 0;
        this.boomEffect.y = centerY / sizeOffset
    };
    d.prototype.setListener = function() {
        var b = this;
        this.addEventListener(egret.Event.ADDED_TO_STAGE, this.reset, this);
        this.addEventListener(egret.Event.REMOVED_FROM_STAGE,
        function() {
            b.removeEventListener(egret.Event.ENTER_FRAME, b.update, b)
        },
        this);
    ...
    d.prototype.reset = function() {
        this.moneyList.removeChildren();
        this.hand.reset();
        this.face.playFrame(3);
        this.boomEffect.alpha = 0;
        this.createMoney();
        this.startAll();
        this.scoreBoard.update(score = 0);
        this.createInterval = createInterval;
        lastTime = egret.getTimer()
    };
    d.prototype.update = function() {
        for (var b = 0; b < this.moneyList.numChildren; b++) {
            var a = this.moneyList.getChildAt(b);
            this.hand.isGrab(a) && this.grabMoney(a)
        }
        egret.getTimer() - this.lastCreateTime > this.createInterval && this.createMoney();
        this.fallMoney(60 / GameProfiler.s_fps);
        this.grabbedMoney.x = this.hand.x;
        this.grabbedMoney.y = this.hand.y
    };
    d.prototype.stopAll = function() {
        this.touchEnabled = !1;
        egret.Tween.removeAllTweens();
        for (var b = 0; b < this.moneyList.numChildren; b++) this.moneyList.getChildAt(b).stop();
        this.removeEventListener(egret.Event.ENTER_FRAME, this.update, this)
    };
    d.prototype.startAll = function() {
        this.touchEnabled = !0;
        this.hand.display.gotoAndStop(3);
        for (var b = 0; b < this.moneyList.numChildren; b++) this.moneyList.getChildAt(b).play();
        this.addEventListener(egret.Event.ENTER_FRAME, this.update, this)
    };
    d.prototype.initVariable = function() {
        this.gameProfiler = new GameProfiler(this);
        this.bg.texture = RES.getRes("game-face");
        this.addChild(this.bg);
        this.mcDataFactory = new egret.MovieClipDataFactory(RES.getRes("Animate_json"), RES.getRes("Animate_png"));
        this.fallingSpeed = 5;
        this.face = new Face;
        this.addChild(this.face);
        this.boomEffect = new egret.Bitmap(RES.getRes("game-boom"));
        this.addChild(this.boomEffect);
        this.moneyList = new egret.DisplayObjectContainer;
        this.addChild(this.moneyList);
        this.scoreBoard = new ScoreBoard;
        this.addChild(this.scoreBoard);
        this.grabbedMoney = new egret.DisplayObjectContainer;
        this.addChild(this.grabbedMoney);
        this.hand = new Hand(this.mcDataFactory);
        this.addChild(this.hand);
        this.moneyPool = new ObjectPool
    };
    return d
} (Panel);
...
Controller = function() {
    function b(b) {
        ...
        local && (egret.localStorage.getItem(gameName) ? bestScore = parseInt(egret.localStorage.getItem(gameName)) : egret.localStorage.setItem(gameName, "" + bestScore));
        this.container = b;
        this.startPanel = new StartPanel;
        this.gamePanel = new GamePanel;
        this.overDialog = new OverDialog;
        this.startPanel.addEventListener("start", this.onGameStart, this);
    ...
    b.prototype.onGameStart = function() {
        ...
        window.cb_start() // sunyang 游戏开始  
    }
    b.prototype.onGameOver = function() {
        this.overDialog.update(score, bestScore, 10 < score ? !0 : !1);
        this.container.addChild(this.overDialog);
        window.cb_gameover(score);
	   updateShare(score);
       //sunyang
       //console.log(score);
	   dentsu.setRankingScoreDesc(score); 
...
function sendEvent(b, d) {
    var c = new egret.Event(b);
    d.dispatchEvent(c)
}
var game, grestart;
...
function saveBest() {
    local && egret.localStorage.setItem(gameName, "" + bestScore)
}
...
Money = function(b) {
    function d(c) {
        b.call(this, (new egret.MovieClipDataFactory(RES.getRes("Animate_json"), RES.getRes("Animate_png"))).generateMovieClipData(c));
        this.speed = 0;
        switch (c) {
        case COIN_IRON:
            this.faceValue = 0.5;
    ...
    __extends(d, b);
    d.prototype.initPos = function() {
        this.y = -(centerY / sizeOffset + this.width / 2);
        this.x = -centerX / sizeOffset + this.width / 2 + Math.random() * (screenW / sizeOffset - this.width)
    };
    d.prototype.falling = function(b) {
        this.speed += acc;
        this.y += b * this.speed;
        this.rotation += b
    };
...
Money.prototype.__class__ = "Money";
var __extends = this.__extends ||
function(b, d) {
    function c() {
        this.constructor = b
...
FACE; (function(b) {
    b[b.MISS = 0] = "MISS";
    b[b.GRABBED = 1] = "GRABBED";
    b[b.GRABBING = 2] = "GRABBING";
    b[b.NORMAL = 3] = "NORMAL"
})(FACE || (FACE = {}));
var Face = function(b) {
    function d() {
        b.call(this);
        this.mc = new egret.MovieClipDataFactory(RES.getRes("Animate_json"), RES.getRes("Animate_png"));
        this.eyebrow = new egret.MovieClip(this.mc.generateMovieClipData("eyebrow"));
        this.glass = new egret.MovieClip(this.mc.generateMovieClipData("glass"));
        this.mouth = new egret.MovieClip(this.mc.generateMovieClipData("mouth"));
        this.addChild(this.eyebrow);
    ...
    d.prototype.playAll = function() {
        this.eyebrow.play( - 1);
        this.glass.play( - 1);
        this.mouth.play( - 1)
    };
    d.prototype.playFrame = function(b) {
        switch (b) {
        case 0:
            this.eyebrow.gotoAndPlay(1, 1);
            this.glass.gotoAndStop(1);
            this.mouth.gotoAndStop(4);
            break;
        case 1:
            this.eyebrow.gotoAndStop(1);
            this.glass.gotoAndPlay(2, 3);
            this.mouth.gotoAndStop(1);
            break;
        case 2:
            this.eyebrow.gotoAndStop(1);
            this.glass.gotoAndStop(2);
            this.mouth.gotoAndStop(3);
            break;
        case 3:
            this.eyebrow.gotoAndStop(2),
            this.glass.gotoAndStop(2),
...
Hand = function(b) {
    function d(c) {
        b.call(this);
        this.withdrawSpeed = 80;
        this.stretchSpeed = 60;
        this.collisonR = 120;
        this.stop = this.isStretching = !1;
        this.angle = 16;
        this.restrictX = 0;
        this.withdrawSpeed = withdrawSpeed;
        this.stretchSpeed = stretchSpeed;
        this.mc = c;
        this.display = new egret.MovieClip(c.generateMovieClipData("hand"));
    ...
    d.prototype.init = function() {
        ...
        this.x = ( - centerX + this.restrictX) / sizeOffset;
        this.y = handInitY;
        this.display.frameRate = 4;
        this.display.gotoAndStop(3)
    };
    d.prototype.reset = function() {
        this.x = -centerX / sizeOffset;
        this.y = 300;
        this.display.gotoAndStop(3);
        this.isStretching = !1
    };
    d.prototype.stretch = function() {
        var b = this;
        if (!this.isStretching) {
            egret.Tween.removeTweens(this);
            var a = -centerX / sizeOffset + screenW / sizeOffset * Math.cos(2 * this.angle * Math.PI / 360),
            d = handInitY - screenW / sizeOffset * Math.sin(2 * this.angle * Math.PI / 360),
            m = (a - this.x) / (stretchRange + centerX / sizeOffset);
            this.isStretching = !0;
            egret.Tween.get(this).to({
                x: a,
                y: d
            },
            stretchSpeed * m).call(function() {
                egret.Tween.removeAllTweens();
                b.isStretching = !1;
                b.withdraw()
            },
    ...
    d.prototype.withdraw = function() {
        this.isStretching = !1;
        egret.Tween.get(this).to({
            x: ( - centerX + this.restrictX) / sizeOffset,
            y: handInitY
        },
        withdrawSpeed, egret.Ease.sineInOut).call(function() {
            egret.Tween.removeAllTweens()
        },
        this)
    };
    d.prototype.isGrab = function(b) {
        return Math.sqrt(Math.pow(this.x - b.x, 2) + Math.pow(this.y - b.y, 2)) < this.collisonR ? !0 : !1
    };
    return d
} (egret.DisplayObjectContainer);
Hand.prototype.__class__ = "Hand";
var __extends = this.__extends ||
function(b, d) {
    function c() {
        this.constructor = b
...
Main = function(b) {
    ...
    d.prototype.onAddToStage = function(b) {
        ...
        RES.loadConfig("resource/resource.json", window.resourceCDN + "resource/");
    ...
    d.prototype.onComplete = function(b) {
...
ScoreBoard = function(b) {
    function d() {
        b.call(this);
        this.textLabel = new egret.TextField;
        this.textLabel.text = "$" + score;
        //this.textLabel.fillStyle = "#005bac";
        this.textLabel.size = 100;
        this.addChild(this.textLabel);
        this.anchorX = this.anchorY = 0.5
    }
    __extends(d, b);
    d.prototype.update = function(b) {
        this.textLabel.text = "$" + b
    };
    return d
} (egret.Sprite);
ScoreBoard.prototype.__class__ = "ScoreBoard";
var ObjectPool = function() {
    function b() {
        this._pool = [];
        this._list = []
    }
    b.prototype.createObject = function(b, c) {
        var a;
        a = this._pool;
        a = null != a && a.length ? a.shift() : new b(c);
        this._list.push(a);
        return a
    };
    b.prototype.destroyObject = function(b) {
        this._pool.push(b);
        b = this._list.indexOf(b); - 1 != b && this._list.splice(b, 1)
    };
...
FPS.prototype.__class__ = "FPS";
var GameProfiler = function() {
    function b(b) {
        this._countTime = this._lastTime = this._fps = 0;
        this.run(b)
    }
    b.prototype.run = function(b) {
        b.addEventListener(egret.Event.ENTER_FRAME, this.calculateFPS, this)
    };
    b.prototype.calculateFPS = function() {
        var d = egret.getTimer(),
        c = d - this._lastTime;
        this._countTime += c;
...
GameProfiler.prototype.__class__ = "GameProfiler";
