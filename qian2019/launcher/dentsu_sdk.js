(function () {
    ...
    g.prototype = {
        ...
        }, setRankingScoreDesc: function (a,
            b) {
        ...
        onpaysucc: function (a) {
            ...
            }, isAppdentsu: function () {
                return navigator.userAgent.match(/dentsu/)
            }, isIosdentsu: function () {
                return "object" === typeof window.webkit ? !0 : navigator.userAgent.match(/IOSdentsu/i)
            }, isIos: function () {
            ...
            getCpWxInfo: function () {
                return window.dentsu_wxinfo ? (console.log(window.dentsu_wxinfo), window.dentsu_wxinfo) : !1
            }
    };
    window.dentsu = new g;
    window.addEventListener("message", function (a) {
        var b = {
            wx_share_succ: function (a) {
                ...
                dentsu.putLocalStorage(b, a)
            }, paysucc: function (a) {
                "function" === typeof dentsu.__paysucc && dentsu.__paysucc(a)
            }, setCpWxInfo: function (a) {
                window.dentsu_wxinfo = a;
               // console.log(window.dentsu_wxinfo)
            }
        };
        ...
        // case "fn":
        //     (b = b[a.data.value.fn]) && "function" == typeof b ? b.apply(window, a.data.value.args) : (
        //         //console.log("======unknow fun ======"),
