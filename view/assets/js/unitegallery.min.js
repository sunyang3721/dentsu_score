...
function UniteGalleryMain() {
	...
	var g_options = {
		...
		gallery_mousewheel_role: "", //sunyang  zoom 滚动事件放大放小功能
...
function UGHtml5MediaAPI() {
	...
	function t(e, t, n, o, a) {
		...
		var g = "<video id='" + u + "' width='" + n + "' height='" + o + "' loop class='hover_play'  preload='none' " + d + " " + _ + ">"; // sunyang  controls='controls'
		...
		g+='<div class="control"><a href="#" class="btnPlay"><i class="glyphicon glyphicon-pause"></i> 暂停</a>';
		g+='<div class="progressTime"><span class="current_modes"></span> / <span class="duration_modes"></span></div>';
		g+='<div class="progress pro-sunyang" style="margin-right:3px;border:1px solid #337AB7;height:19px;width:80%;float:right;margin-top:1px;background-color:#d4d4d4;"><div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuemin="0" aria-valuemax="100" style="width:0%"></div></div>';
		g+='</div>', 
		jQuery("#" + e).html(g), 
		//sunyang  播放/暂停按钮
		play_modes = $('#gallery_videoplayer_html5_video').get(0);
		//hover 渐隐渐显
		// $('.hover_play').hover(function(){
		// 	//alert('ss');
		// });
		// $('.hover_play').mouseleave(function(){
		// 	//console.log('lik ');
		// })
